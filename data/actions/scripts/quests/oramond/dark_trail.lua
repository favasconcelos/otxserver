...
function onUse(cid, item, fromPosition, itemEx) -- {x = 33477, y = 32102, z = 9}   {x = 33500, y = 32124, z = 9}
  ...
  if item.itemid == 1945 then
    if
      player:getStorageValue(1) and
        not isPlayerInArea({x = 33475, y = 32068, z = 8, stackpos = 255}, {x = 33499, y = 32092, z = 8, stackpos = 255})
     then
      ...
      doPlayerSendTextMessage(cid, 19, "There are players inside the room or is missing players here.")
    end
  end
  return true
end
