local config = {
  ...
  walls = {
    {
      from = Position(33275, 31834, 12),
      to = Position(33275, 31838, 12),
      wallId = 5072,
      soundPosition = Position(33275, 31836, 12)
    },
    {
      from = Position(33266, 31843, 12),
      to = Position(33270, 31843, 12),
      wallId = 5071,
      soundPosition = Position(33268, 31843, 12)
    },
    {
      from = Position(33260, 31834, 12),
      to = Position(33260, 31838, 12),
      wallId = 5072,
      soundPosition = Position(33260, 31836, 12)
    },
    {
      from = Position(33266, 31828, 12),
      to = Position(33270, 31828, 12),
      wallId = 5071,
      soundPosition = Position(33268, 31828, 12)
    }
  },
  roomArea = {
  ...
  machineStorages = {
    GlobalStorage.ElementalSphere.Machine1,
    GlobalStorage.ElementalSphere.Machine2,
    GlobalStorage.ElementalSphere.Machine3,
    GlobalStorage.ElementalSphere.Machine4
  },
  centerPosition = Position(33267, 31836, 12),
  effectPositions = {
    Position(33261, 31829, 12),
    Position(33262, 31830, 12),
    Position(33263, 31831, 12),
    Position(33264, 31832, 12),
    Position(33265, 31833, 12),
    Position(33266, 31834, 12),
    Position(33267, 31835, 12),
    Position(33268, 31836, 12),
    Position(33269, 31837, 12),
    Position(33270, 31838, 12),
    Position(33271, 31839, 12),
    Position(33272, 31840, 12),
    Position(33273, 31841, 12),
    Position(33274, 31842, 12),
    Position(33274, 31829, 12),
    Position(33273, 31830, 12),
    Position(33272, 31831, 12),
    Position(33271, 31832, 12),
    Position(33270, 31833, 12),
    Position(33269, 31834, 12),
    Position(33268, 31835, 12),
    Position(33267, 31836, 12),
    Position(33266, 31837, 12),
    Position(33265, 31838, 12),
    Position(33264, 31839, 12),
    Position(33263, 31840, 12),
    Position(33262, 31841, 12),
...
local function warnPlayers(players)
  ...
  player:say(
    "You have 5 minutes from now on until you get teleported out.",
    TALKTYPE_MONSTER_YELL,
    false,
    0,
    Position(33266, 31835, 13)
  )
end
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
  ...
  player:say(
    "You have 10 minutes from now on until you get teleported out.",
    TALKTYPE_MONSTER_YELL,
    false,
    0,
