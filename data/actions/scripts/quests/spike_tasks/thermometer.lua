hot_lava_pools = {
  --all range areas of the 9 lava pools
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
  ...
  if
    player:getPosition():isInRange(
      hot_lava_pools[SPIKE_LOWER_HOTTEST_POOL][1],
      hot_lava_pools[SPIKE_LOWER_HOTTEST_POOL][2]
    )
   then
    item:remove()
    ...
    player:sendTextMessage(
      ...
      "Whew! That was that hot, it melted the thermometer! At least you've found the hot spot!"
    )
  else
