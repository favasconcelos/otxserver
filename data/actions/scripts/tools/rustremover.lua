local CHAIN_ARMOR,
  ...
  GOLDEN_ARMOR,
  DRAGON_SCALE_MAIL,
  MAGIC_PLATE_ARMOR = 2464, 2483, 2465, 2463, 2476, 8891, 2487, 2466, 2492, 2472
local STUDDED_LEGS, CHAIN_LEGS, BRASS_LEGS, PLATE_LEGS, KNIGHT_LEGS, CROWN_LEGS, GOLDEN_LEGS =
  2468,
  2648,
  2478,
  2647,
  ...
  2488,
  2470
local BRASS_HELMET, IRON_HELMET, STEEL_HELMET, CROWN_HELMET, CRUSADER_HELMET, ROYAL_HELMET =
  2460,
  2459,
  2457,
  2491,
  ...
  for i = 1, #targetItem do
    if chance >= targetItem[i][1][1] and chance <= targetItem[i][1][2] then
      if targetItem[i][2] then
        ...
        player:say(
          (isInArray({9808, 9809, 9810}, target.itemid) and
            "The item was already damaged so badly that it broke when you tried to clean it." or
            "The item were already damaged so badly that they broke when you tried to clean them."),
