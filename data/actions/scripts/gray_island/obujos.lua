function onUse(cid, item, fromPosition, itemEx, toPosition)
  ...
  if randomitem == 1 then
    ...
    return doPlayerSendTextMessage(
      cid,
      19,
      "You have found 1 trophy of obujos, 30 platinum coins, 1 deepling staff, 1 guardian axe and 1 obujos shell."
    )
  elseif randomitem == 2 then
    ...
    return doPlayerSendTextMessage(
      cid,
      19,
      "You have found 1 trophy of obujos, 30 platinum coins, 1 deepling staff, 1 guardian axe and 1 giant shimmering pearl."
    )
  end
end
