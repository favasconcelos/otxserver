function onUse(cid, item, fromPosition, itemEx, toPosition)
  ...
  if randomitem == 1 then
    ...
    return doPlayerSendTextMessage(
      cid,
      19,
      "You have found 1 trophy of tanjis, 20 platinum coins, 1 necklace of the deep, 1 warrior shield and 1 tanjis sight."
    )
  elseif randomitem == 2 then
    ...
    return doPlayerSendTextMessage(
      cid,
      19,
      "You have found 1 trophy of tanjis, 20 platinum coins, 1 necklace of the deep, 1 warrior shield and 10 black pearl."
    )
  end
end
