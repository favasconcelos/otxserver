function onUse(cid, item, fromPosition, itemEx, toPosition)
  ...
  if randomitem == 1 then
    ...
    return doPlayerSendTextMessage(
      cid,
      19,
      "You have found 1 trophy of jaul, 50 platinum coins, 1 warrior shield, 1 guardian axe and 1 jaul pearl."
    )
  elseif randomitem == 2 then
    ...
    return doPlayerSendTextMessage(
      cid,
      19,
      "You have found 1 trophy of jaul, 50 platinum coins, 1 warrior shield, 1 guardian axe and 1 necklace of the deep."
    )
  end
end
