  ...
  if (itemEx.itemid == 24732) then
    if
      player:getStorageValue(1) and
        not isPlayerInArea({x = 32244, y = 32169, z = 9, stackpos = 255}, {x = 32267, y = 32189, z = 9, stackpos = 255})
     then
      ...
      if (isPlayer(getTopCreature(pos1).uid)) then
        ...
        doCreatureSay(cid, "You need 10 players for enter in Arena.", TALKTYPE_ORANGE_1)
      end
    else
