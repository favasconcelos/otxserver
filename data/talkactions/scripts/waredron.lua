      ...
      if (getPlayerGuildLevel(tid) == 3) then
        doPlayerSendTextMessage(
          ...
          '[WAR AREA] Sua guild recebeu um convite da guild ' ..
            inguild .. ' para ' .. tonumber(minutos) .. ' minutos na Area de Edron x Cormaya, voce tem 1 minuto para usar !waredron "accept para aceitar ou !waredron "reject para rejeitar!.'
        )
      else
