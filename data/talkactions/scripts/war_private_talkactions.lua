...
function onSay(cid, words, param)
  ...
  if status == 'accept' then
    ...
    broadcastMessage(
      'The guild ' .. enemyName .. ' accepted war private with the guild ' .. guildName .. ' to war private with ' .. warPrivate_duration .. ' minutes duration. To enter war use the command.',
