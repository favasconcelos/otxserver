...
keywordHandler:addKeyword(
  {"stake"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I guess you couldn't convince Gamon to give you a stake, eh?"},
  function(player)
...
keywordHandler:addKeyword(
  {"stake"},
  StdModule.say,
  {npcHandler = npcHandler, text = "You should visit Tibra in the Carlin church now."},
  function(player)
...
npcHandler:setMessage(
  MESSAGE_GREET,
  "Welcome, young |PLAYERNAME|! If you are heavily wounded or poisoned, I can {heal} you for free or you want the {adventurer stone}?"
)
