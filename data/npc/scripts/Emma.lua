...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 2 then
      if player:removeItem(8190, 1) then
        ...
        npcHandler:say(
          "How unnecessarily complicated, but that's the way those Thaians are. In the end we got what we wanted and they can't do anything about it.",
          cid
        )
      else
    ...
    elseif npcHandler.topic[cid] == 6 then
      if player:removeItem(7703, 1) then
        ...
        npcHandler:say(
          "I will have this correspondence examined by our specialists. I am sure they are quite revealing.",
          cid
        )
      else
    ...
    elseif npcHandler.topic[cid] == 7 then
      if player:removeItem(7704, 1) then
        ...
        npcHandler:say(
          "I hope this old book will do those researches any good. Personally I see little use to proof some bloodlines after we cut all ties to Thais.",
          cid
        )
      else
      ...
      npcHandler:say(
        {
          ...
          "If you join, you dedicate your service to Carlin alone! Do you truly think that you are girl enough to join the brigade?" or
  ...
  elseif msgcontains(msg, "mission") then
    ...
    elseif
      player:getStorageValue(Storage.secretService.CGBMission01) == 2 and
    ...
    elseif
      player:getStorageValue(Storage.secretService.CGBMission02) == 2 and
    ...
    elseif
      player:getStorageValue(Storage.secretService.CGBMission03) == 3 and
    ...
    elseif
      player:getStorageValue(Storage.secretService.CGBMission04) == 2 and
    ...
    elseif
      player:getStorageValue(Storage.secretService.CGBMission05) == 2 and
    ...
    elseif
      player:getStorageValue(Storage.secretService.CGBMission06) == 2 and
