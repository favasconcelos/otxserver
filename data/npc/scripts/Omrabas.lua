...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "mission") then
    if player:getStorageValue(Storage.GravediggerOfDrefia.QuestStart) < 1 then
      npcHandler:say(
        "Hmm. You could be of assistance, I presume. I need several body parts. I will reward you adequately. Interested?",
        cid
      )
      player:setStorageValue(Storage.GravediggerOfDrefia.QuestStart, 1)
      npcHandler.topic[cid] = 1
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission01) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission02) < 1
     then
      npcHandler:say("Ah hello, young friend! Did you bring me two ghoul snacks as requested?", cid)
      npcHandler.topic[cid] = 2
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission02) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission03) < 1
     then
      npcHandler:say(
        "Ah, young friend, I found a solution! Find me two {demonic skeletal hands}. That should do it. Now run along! Ask me for {mission} when you're done.",
        cid
      )
      player:setStorageValue(Storage.GravediggerOfDrefia.Mission03, 1)
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission03) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission04) < 1
     then
      npcHandler:say("Ah hello again! You look as if you could, er, lend me a hand or two? Yes?", cid)
      npcHandler.topic[cid] = 3
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission04) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission05) < 1
     then
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission06) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission07) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission07) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission08) < 1
     then
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission09) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission10) < 1
     then
      npcHandler:say(
        "Yes, yes, hello. Tell me if you lost something. If not, do you have that stimulated brain with you?",
        cid
      )
      npcHandler.topic[cid] = 5
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission10) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission11) < 1
     then
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission12) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission13) < 1
     then
      npcHandler:say("Hello, hello. Let's come to the point - did you find me some intestines?", cid)
      npcHandler.topic[cid] = 6
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission13) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission14) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission15) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission16) < 1
     then
      npcHandler:say(
        "Ah hello! Well done there, I felt the old powers settling down. Now, {ready} to hallow the next altar?",
        cid
      )
      player:setStorageValue(Storage.GravediggerOfDrefia.Mission16, 1)
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission16) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission17) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission17) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission18) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission20) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission21) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission21) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission22) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission25) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission26) < 1
     then
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission29) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission30) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission33) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission34) < 1
     then
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission42) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission43) < 1
     then
      npcHandler:say("Yes? Do you have the {scroll} piece? ", cid)
      npcHandler.topic[cid] = 11
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission43) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission44) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission50) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission51) < 1
     then
      npcHandler:say("Ah, hello! I take it you have the next scroll piece for me, {yes}?", cid)
      npcHandler.topic[cid] = 12
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission51) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission52) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission57) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission58) < 1
     then
      npcHandler:say("Hello - what? You have the {scroll} piece, you say?", cid)
      npcHandler.topic[cid] = 13
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission58) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission59) < 1
     then
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission64) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission65) < 1
     then
      npcHandler:say("Hello, young apprentice. Do you have that {scroll} piece from the priestess?", cid)
      player:addItem(21464, 1)
      npcHandler.topic[cid] = 14
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission65) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission66) < 1
     then
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission70) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission71) < 1
     then
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 2 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission01) == 1 then
      if player:removeItem(12423, 2) then
        ...
        npcHandler:say(
          "Splendid! What? They're half gnawed! There are no hands! Hrmmm. Let me think of a solution. Ask me for a new {mission}.",
          cid
        )
        npcHandler.topic[cid] = 0
      else
    ...
    elseif npcHandler.topic[cid] == 3 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission03) == 1 then
      if player:removeItem(10564, 2) then
        npcHandler:say(
          "Yes. Those will be adequate. Talk to me again if you want to continue with your next {mission}.",
          cid
        )
    ...
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission22) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission23) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
      npcHandler.topic[cid] == 9 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission26) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission27) < 1
     then
      npcHandler:say(
        {
      ...
      npcHandler.topic[cid] = 0
    elseif
      npcHandler.topic[cid] == 10 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission34) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission35) < 1
     then
    ...
    elseif npcHandler.topic[cid] == 11 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission42) == 1 then
      if player:removeItem(21250, 1) then
        npcHandler:say(
          "This is it! This is it! Well done, well done! And now, on to the {next} scroll piece, {yes}?",
          cid
        )
    ...
    elseif npcHandler.topic[cid] == 12 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission50) == 1 then
      if player:removeItem(21250, 1) then
        npcHandler:say(
          "Indeed it is! The second scroll piece! Splendid! Here you go - for your trouble. And now, on to the {next} scroll piece, {yes}? ",
          cid
        )
    ...
    elseif
     ...
     then
      ...
      player:setStorageValue(Storage.GravediggerOfDrefia.Mission52, 1)
    elseif
      npcHandler.topic[cid] == 13 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission57) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission58) < 1
     then
      if player:removeItem(21250, 1) then
    ...
    elseif
      npcHandler.topic[cid] == 15 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission68) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission69) < 1
     then
      if player:removeItem(21250, 1) then
    ...
    elseif
     ...
     then
      ...
      player:setStorageValue(Storage.GravediggerOfDrefia.Mission69, 1)
    elseif
      npcHandler.topic[cid] == 15 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission69) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission72) < 1
     then
      if player:removeItem(21250, 1) then
    ...
    elseif
      npcHandler.topic[cid] == 17 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission73) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission74) < 1
     then
      npcHandler:say(
        {
  ...
  elseif
    msgcontains(msg, "give") and npcHandler.topic[cid] == 4 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission06) == 1
   then
    if player:removeItem(21394, 1) then
      npcHandler:say("Ah... <sighs> Very good. Just say the word when you are ready for the next {mission}.", cid)
      player:setStorageValue(Storage.GravediggerOfDrefia.Mission07, 1)
  ...
  elseif
    msgcontains(msg, "undertake") and player:getStorageValue(Storage.GravediggerOfDrefia.Mission13) == 1 and
      npcHandler.topic[cid] == 7
   then
    npcHandler:say(
      {
    ...
    npcHandler.topic[cid] = 0
  elseif
    msgcontains(msg, "ready") and player:getStorageValue(Storage.GravediggerOfDrefia.Mission16) == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission17) < 1
   then
    npcHandler:say(
      {
    ...
    player:setStorageValue(Storage.GravediggerOfDrefia.Mission17, 1)
  elseif
    msgcontains(msg, "problem") and player:getStorageValue(Storage.GravediggerOfDrefia.Mission17) == 1 and
      npcHandler.topic[cid] == 8
   then
    npcHandler:say(
      "What? No bones around you say? Hrmmm. Wait. Check the skull heap here - that's right - hah! There! Now get to work!",
      cid
    )
    ...
    npcHandler.topic[cid] = 0
  elseif
    msgcontains(msg, "blood") and player:getStorageValue(Storage.GravediggerOfDrefia.Mission21) == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission22) < 1
   then
    npcHandler:say(
      {
    ...
    player:setStorageValue(Storage.GravediggerOfDrefia.Mission22, 1)
  elseif
    msgcontains(msg, "proceed") and player:getStorageValue(Storage.GravediggerOfDrefia.Mission30) == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission31) < 1
   then
  ...
  elseif msgcontains(msg, "scroll") then
    if
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission34) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission35) < 1
     then
      npcHandler:say(
        {
    ...
    elseif
     ...
     then
      ...
      player:addItem(21464, 1)
    elseif
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission68) == 1 and
        player:getStorageValue(Storage.GravediggerOfDrefia.Mission69) < 1
     then
      npcHandler:say("Welcome, welcome! Finally! The last {scroll} piece.... you do have it, haven't you?", cid)
      npcHandler.topic[cid] = 15
  ...
  elseif
    msgcontains(msg, "restore") and player:getStorageValue(Storage.GravediggerOfDrefia.Mission69) <= 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission73) < 1
   then --and npcHandler.topic[cid] == 15 then
    ...
    npcHandler:say("Chzzzz. wtf??@! leave.", cid)
  end
  return true
end
