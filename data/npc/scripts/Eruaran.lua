...
local function greetCallback(cid)
  ...
  if player:getStorageValue(Storage.EruaranGreeting) > 0 then
    npcHandler:setMessage(
      MESSAGE_GREET,
      "Ashari Lillithy, so we meet {again}! What brings you here this time, general {information}, {transform}, {improve}, {create}, {outfit}, or {talk}?"
    )
  else
...
local function creatureSayCallback(cid, type, msg)
    ...
    if action[cid] == ACTION.CREATE then
      npcHandler:say(
        "Do you want to spend " ..
          (Config.Create.DreamMatter == 1 and "your" or Config.Create.DreamMatter) ..
            " dream matter with " ..
              (Config.Create.Clusters > 1 and "those" or "your") ..
                " " .. Config.Create.Clusters .. " clusters of {solace} and give a shot. {Yes} or {no}",
        cid
      )
      npcHandler.topic[cid] = 3
    elseif action[cid] == ACTION.IMPROVE then
      npcHandler:say(
        "Do you want to spend your crude umbral " ..
          (weapon_sub[cid] == SUB_TYPES.BLADE and "blade" or "slayer") ..
            " with " ..
              (Config.Improve.Clusters > 1 and "those" or "your") ..
                " " .. Config.Improve.Clusters .. " clusters of {solace} and give a shot. {Yes} or {no}?",
        cid
      )
      npcHandler.topic[cid] = 3
    elseif action[cid] == ACTION.TRANSFORM then
      npcHandler:say(
        "Do you want to spend your umbral " ..
          (weapon_sub[cid] == SUB_TYPES.BLADE and "blade" or "slayer") ..
            " with " ..
              (Config.Transform.Clusters > 1 and "those" or "your") ..
                " " .. Config.Transform.Clusters .. " clusters of {solace} and give it a shot. {Yes} or {no}?",
        cid
      )
      npcHandler.topic[cid] = 3
    end
  ...
  elseif msgcontains(msg, "axe") or msgcontains(msg, "chopper") and npcHandler.topic[cid] == 2 then
    ...
    if action[cid] == ACTION.CREATE then
      npcHandler:say(
        "Do you want to spend your dream matter with those 25 clusters of {solace} and give a shot. {Yes} or {no}",
        cid
      )
      npcHandler.topic[cid] = 3
    elseif action[cid] == ACTION.IMPROVE then
      npcHandler:say(
        "Do you want to spend your crude umbral " ..
          (weapon_sub[cid] == SUB_TYPES.AXE and "axe" or "chopper") ..
            " with " ..
              (Config.Improve.Clusters > 1 and "those" or "your") ..
                " " .. Config.Improve.Clusters .. " clusters of {solace} and give a shot. {Yes} or {no}?",
        cid
  ...
  elseif isInArray({"mace", "hammer"}, msg) and npcHandler.topic[cid] == 2 then
    ...
    if action[cid] == ACTION.CREATE then
      npcHandler:say(
        "Do you want to spend your dream matter with " ..
          (Config.Create.Clusters > 1 and "those" or "your") ..
            " " .. Config.Create.Clusters .. " clusters of {solace} and give a shot. {Yes} or {no}",
        cid
      )
    ...
    elseif action[cid] == ACTION.IMPROVE then
      npcHandler:say(
        "Do you want to spend your crude umbral " ..
          (weapon_sub[cid] == SUB_TYPES.MACE and "mace" or "hammer") ..
            " with " ..
              (Config.Improve.Clusters > 1 and "those" or "your") ..
                " " .. Config.Improve.Clusters .. " clusters of {solace} and give a shot. {Yes} or {no}?",
        cid
  ...
  elseif msgcontains(msg, "bow") and npcHandler.topic[cid] == 1 then
    ...
    elseif action[cid] == ACTION.IMPROVE then
      npcHandler:say(
        "Do you want to spend your crude umbral bow with " ..
          (Config.Improve.Clusters > 1 and "those" or "your") ..
            " " .. Config.Improve.Clusters .. " clusters of {solace} and give a shot. {Yes} or {no}?",
        cid
      )
    ...
    elseif action[cid] == ACTION.TRANSFORM then
      npcHandler:say(
        "Do you want to spend your umbral bow with " ..
          (Config.Transform.Clusters > 1 and "those" or "your") ..
            " " .. Config.Transform.Clusters .. " clusters of {solace} and give it a shot. {Yes} or {no}?",
        cid
      )
  ...
  elseif msgcontains(msg, "crossbow") and npcHandler.topic[cid] == 1 then
    ...
    elseif action[cid] == ACTION.IMPROVE then
      npcHandler:say(
        "Do you want to spend your crude umbral crossbow with " ..
          (Config.Improve.Clusters > 1 and "those" or "your") ..
            " " .. Config.Improve.Clusters .. " clusters of {solace} and give a shot. {Yes} or {no}?",
        cid
      )
    ...
    elseif action[cid] == ACTION.TRANSFORM then
      npcHandler:say(
        "Do you want to spend your umbral crossbow with " ..
          (Config.Transform.Clusters > 1 and "those" or "your") ..
            " " .. Config.Transform.Clusters .. " clusters of {solace} and give it a shot. {Yes} or {no}?",
        cid
      )
  ...
  elseif msgcontains(msg, "spellbook") and npcHandler.topic[cid] == 1 then
    ...
    elseif action[cid] == ACTION.IMPROVE then
      npcHandler:say(
        "Do you want to spend your crude umbral spellbook with " ..
          (Config.Improve.Clusters > 1 and "those" or "your") ..
            " " .. Config.Improve.Clusters .. " clusters of {solace} and give a shot. {Yes} or {no}?",
        cid
      )
    ...
    elseif action[cid] == ACTION.TRANSFORM then
      npcHandler:say(
        "Do you want to spend your umbral spellbook with " ..
          (Config.Transform.Clusters > 1 and "those" or "your") ..
            " " .. Config.Transform.Clusters .. " clusters of {solace} and give it a shot. {Yes} or {no}?",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 3 then
    if action[cid] == ACTION.CREATE then --create
      if
        player:getItemCount(IDS.DREAM_MATTER) >= 1 and
          player:getItemCount(IDS.CLUSTER_OF_SOLACE) >= Config.Create.Clusters
       then
        if math.random(100) <= Config.Create.Chance then
          local newItemId =
            (weapon[cid] == TYPES.SWORD and
            (weapon_sub[cid] == SUB_TYPES.BLADE and IDS.CRUDE_UMBRAL_BLADE or IDS.CRUDE_UMBRAL_SLAYER) or
            weapon[cid] == TYPES.AXE and
              (weapon_sub[cid] == SUB_TYPES.AXE and IDS.CRUDE_UMBRAL_AXE or IDS.CRUDE_UMBRAL_CHOPPER) or
            weapon[cid] == TYPES.CLUB and
              (weapon_sub[cid] == SUB_TYPES.MACE and IDS.CRUDE_UMBRAL_MACE or IDS.CRUDE_UMBRAL_HAMMER) or
            weapon[cid] == TYPES.BOW and IDS.CRUDE_UMBRAL_BOW or
            weapon[cid] == TYPES.CROSSBOW and IDS.CRUDE_UMBRAL_CROSSBOW or
            weapon[cid] == TYPES.SPELLBOOK and IDS.CRUDE_UMBRAL_SPELLBOOK or
            false)
          if newItemId then
            ...
            npcHandler:say(
              "Your dreams are strong, the creation was successful. Take your " .. ItemType(newItemId):getName() .. ".",
              cid
            )
          else
        ...
        if newItemId and oldItemId then
          if player:getItemCount(oldItemId) > 0 then
            if math.random(100) <= Config.Improve.Chance then
              ...
              npcHandler:say(
                "Your dreams are strong, the improvement was successful. Take your " ..
                  ItemType(newItemId):getName() .. ".",
                cid
              )
            else
              npcHandler:say("Oh no! The process failed.", cid)
              ...
              player:removeItem(
                (rand <= Config.Improve.BreakChance and oldItemId or IDS.CLUSTER_OF_SOLACE),
                (rand <= Config.Improve.BreakChance and 1 or Config.Improve.Clusters)
              )
            end
          else
            npcHandler:say(
              "You do not have " ..
                ItemType(oldItemId):getArticle() .. " " .. ItemType(oldItemId):getName() .. " with you.",
              cid
            )
          end
        else
    ...
    elseif action[cid] == ACTION.TRANSFORM then --transform
      local oldItemId =
        (weapon[cid] == TYPES.SWORD and (weapon_sub[cid] == SUB_TYPES.BLADE and IDS.UMBRAL_BLADE or IDS.UMBRAL_SLAYER) or
        weapon[cid] == TYPES.AXE and (weapon_sub[cid] == SUB_TYPES.AXE and IDS.UMBRAL_AXE or IDS.UMBRAL_CHOPPER) or
        weapon[cid] == TYPES.CLUB and (weapon_sub[cid] == SUB_TYPES.MACE and IDS.UMBRAL_MACE or IDS.UMBRAL_HAMMER) or
        weapon[cid] == TYPES.BOW and IDS.UMBRAL_BOW or
        weapon[cid] == TYPES.CROSSBOW and IDS.UMBRAL_CROSSBOW or
        weapon[cid] == TYPES.SPELLBOOK and IDS.UMBRAL_SPELLBOOK or
        false)
      local newItemId = (oldItemId and oldItemId + 1 or false)
        ...
        if newItemId and oldItemId then
          if player:getItemCount(oldItemId) > 0 then
            if math.random(100) <= Config.Transform.Chance then
              ...
              npcHandler:say(
                "Your dreams are strong, the transforming was successful. Take your " ..
                  ItemType(newItemId):getName() .. ".",
                cid
              )
            else
...
keywordHandler:addKeyword(
  ...
  StdModule.say,
  {
    ...
    text = "What addon you are looking? I need for first addon: {Dream Warden Claw} and for second {Dream Warden Mask}."
  }
)
...
node1 =
  ...
  StdModule.say,
  {
    npcHandler = npcHandler,
    onlyFocus = true,
    text = "To achieve the first Dream addon you need to give me 1 Dream Warden Claw. Do you have them with you?"
  }
)
...
node2 =
  ...
  StdModule.say,
  {
    npcHandler = npcHandler,
    onlyFocus = true,
    text = "To achieve the second Dream addon you need to give me 1 Dream Warden Mask. Do you have them with you?"
  }
)
