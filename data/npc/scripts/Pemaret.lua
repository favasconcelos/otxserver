...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "marlin") then
    if player:getItemCount(7963) > 0 then
      npcHandler:say(
        "WOW! You have a marlin!! I could make a nice decoration for your wall from it. May I have it?",
        cid
      )
...
addTravelKeyword(
  "eremo",
  "Oh, you know the good old sage Eremo. I can bring you to his little island. Do you want me to do that?",
  0,
  Position(33314, 31883, 7)
)
...
keywordHandler:addKeyword(
  {"cormaya"},
  StdModule.say,
  {npcHandler = npcHandler, text = "It's a lovely and peaceful isle. Did you already visit the nice sandy beach?"}
)
keywordHandler:addKeyword(
  {"name"},
  StdModule.say,
  {npcHandler = npcHandler, text = "My name is Pemaret, the fisherman."}
)
