...
function creatureSayCallback(cid, type, msg)
  ...
  elseif (msgcontains(msg, "traces")) then
    if (npcHandler.topic[cid] == 3) then
      npcHandler:say(
        "Some of the more daring of us tried to follow the tracks that were left, but they always lost the trail close to the abandoned sewers, in the east of the sewer system.",
        cid
      )
