...
local function addTravelKeyword(keyword, text, cost, destination)
  local travelKeyword =
    ...
    {keyword},
    StdModule.say,
    {npcHandler = npcHandler, text = "Do you want to sail " .. text, cost = cost}
  )
  travelKeyword:addChildKeyword(
    {"yes"},
    StdModule.travel,
    {npcHandler = npcHandler, premium = false, cost = cost, destination = destination}
  )
  travelKeyword:addChildKeyword(
    {"no"},
    StdModule.say,
...
keywordHandler:addKeyword(
  {"passage"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Where do you want to go? To {Tibia}, {Senja} or {Vega}?"}
)
