...
keywordHandler:addKeyword(
  {"information"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Help yourself. Or ask the other {citizens}, I don't have time for that."}
)
...
keywordHandler:addKeyword(
  {"cook"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I try out old and new {recipes}. You can sell all {food} to me."}
)
keywordHandler:addKeyword(
  {"recipe"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"rookgaard"},
  StdModule.say,
  {npcHandler = npcHandler, text = "This island would be wonderful if there weren't a constant flood of newcomers."}
)
...
keywordHandler:addKeyword(
  {"weapon"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I'm not in the weapon business, so stop disturbing me."}
)
keywordHandler:addKeyword(
  {"king"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I'm glad that we don't see many officials here."}
)
keywordHandler:addKeyword({"god"}, StdModule.say, {npcHandler = npcHandler, text = "I'm a farmer, not a preacher."})
keywordHandler:addKeyword(
  {"sewer"},
  StdModule.say,
  {npcHandler = npcHandler, text = "What about them? Do you live there?"}
)
keywordHandler:addKeyword(
  {"dungeon"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I've got no time for your dungeon nonsense."}
)
keywordHandler:addKeyword(
  {"rat"},
  StdModule.say,
  {npcHandler = npcHandler, text = "My cousin {Billy} cooks rat stew. Yuck! Can you imagine that?"}
)
keywordHandler:addKeyword(
  {"monster"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"billy"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Don't ever mention his name again! He can't even {cook}!"}
)
...
keywordHandler:addKeyword(
  {"lee'delle"},
  StdModule.say,
  {npcHandler = npcHandler, text = "She thinks she owns this island with her underpriced offers."}
)
...
keywordHandler:addKeyword(
  {"obi"},
  StdModule.say,
  {npcHandler = npcHandler, text = "This old guy has only money on his mind."}
)
keywordHandler:addKeyword(
  {"oracle"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Hopefully it gets you off this island soon so you can stop bugging me."}
)
keywordHandler:addKeyword(
  {"paulie"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Uptight and correct in any situation."}
)
keywordHandler:addKeyword(
  {"santiago"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"seymour"},
  StdModule.say,
  {npcHandler = npcHandler, text = "This joke of a man thinks he is sooo important."}
)
...
keywordHandler:addKeyword(
  {"zirella"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Too old to be interesting for me."}
)
...
local bananaKeyword =
  ...
  {"banana"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Have you found a banana for me?"}
)
bananaKeyword:addChildKeyword(
  {"yes"},
  StdModule.say,
  {npcHandler = npcHandler, text = "A banana! Great. Here, take this shield, I don't need it anyway.", reset = true},
  function(player)
...
bananaKeyword:addChildKeyword(
  {"yes"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Are you trying to mess with me?!", reset = true}
)
