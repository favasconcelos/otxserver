...
local function addTravelKeyword(keyword, text, cost, destination)
  local travelKeyword =
    ...
    {keyword},
    StdModule.say,
    {npcHandler = npcHandler, text = "Do you want go to " .. text .. " for |TRAVELCOST|?", cost = cost}
  )
...
keywordHandler:addKeyword(
  {"offer"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I can take you to {Yalahar} or {Mistrock}!"}
)
keywordHandler:addKeyword(
  {"passage"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"captain"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I am Maris, Captain of this ship."}
)
