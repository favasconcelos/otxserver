...
function creatureSayCallback(cid, type, msg)
  ...
  elseif (msgcontains(msg, "notebook")) then
    ...
    selfSay(
      "You need to kill the {The Ravager}, click on statue and then come here say {ritual}, {abandoned sewers}, {notebook} and after this find Roswitha and talk with she.",
      cid
    )
  end
