  ...
  if (msgcontains(msg, "mission")) then
    if (player:getStorageValue(Storage.TheInquisition.Questline) == 6) then
      ...
      if (player:getStorageValue(Storage.TheInquisition.StorkusVampiredust) < 20) then
        npcHandler:say(
          "So far ye've brought me " ..
            player:getItemCount(5905) .. " of 20 {vampire dusts}. Do ye' have any more with ye'? ",
          cid
        )
    ...
    elseif
      (player:getStorageValue(Storage.TheInquisition.Questline) == 8 or
        player:getStorageValue(Storage.TheInquisition.Questline) == 9)
     then
  ...
  elseif (msgcontains(msg, "yes")) then
    if (npcHandler.topic[cid] == 1) then
      ...
      player:setStorageValue(
        ...
        player:getStorageValue(Storage.TheInquisition.StorkusVampiredust) + count
      )
      player:removeItem(5905, count)
      npcHandler:say(
        "Ye've brought me " ..
          count .. " vampire dusts. " .. (20 - player:getStorageValue(Storage.TheInquisition.StorkusVampiredust)) ==
          0 and
          ("Ask me for a {mission} to continue your quest.") or
          ("Ye' need to bring " .. (20 - player:getStorageValue(Storage.TheInquisition.StorkusVampiredust)) .. " more."),
        cid
      )
      npcHandler.topic[cid] = 0
    elseif (npcHandler.topic[cid] == 3) then
      if player:removeItem(9020, 1) then
        npcHandler:say(
          "Ye' brought the token needed to advance to the first vampire hunter rank. I consider that a fluke, but still, congrats! Let me share some of my experience with ye'.",
          cid
        )
    ...
    elseif (npcHandler.topic[cid] == 4) then
      if player:removeItem(9020, 4) then
        npcHandler:say(
          "Ye' brought the four tokens needed to advance to the second vampire hunter rank. Pretty lucky ye' are! Let me share some of my experience with ye'.",
          cid
        )
    ...
    elseif (npcHandler.topic[cid] == 5) then
      if player:removeItem(9020, 5) then
        npcHandler:say(
          "Ye' brought the five tokens needed to advance to the third vampire hunter rank. Wow, you're pretty determined! Let me share some of my experience with ye'.",
          cid
        )
    ...
    elseif (npcHandler.topic[cid] == 6) then
      if player:removeItem(9020, 10) then
        npcHandler:say(
          "Ye' brought the ten tokens needed to advance to the fourth vampire hunter rank. You're absolutely painstaking! Let me share some of my experience with ye'.",
          cid
        )
    ...
    elseif (npcHandler.topic[cid] == 7) then
      if player:removeItem(9020, 30) then
        npcHandler:say(
          "Ye' brought the thirty tokens needed to advance to the fifth vampire hunter rank. You're completely obliterative, kid! Let me share some of my experience with ye'.",
          cid
        )
    ...
    elseif (npcHandler.topic[cid] == 8) then
      if player:removeItem(9020, 50) then
        npcHandler:say(
          "Ye' brought the fifty tokens needed to advance to the last vampire hunter rank. Now that's something. You're razing-amazing! Let me share some of my experience and a little something with ye'!",
          cid
        )
