...
addTravelKeyword(
  ...
  function(player)
    return player:getStorageValue(Storage.SearoutesAroundYalahar.PortHope) ~= 1 and
...
keywordHandler:addKeyword(
  ...
  {
    npcHandler = npcHandler,
    text = "Where do you want to go - {Thais}, {Darashia}, {Venore}, {Liberty Bay}, {Ankrahmun}, {Yalahar} or {Edron?}"
  }
)
keywordHandler:addKeyword(
  {"passage"},
...
keywordHandler:addKeyword(
  {"job"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Im the captain of the Poodle, the proudest ship on all oceans."}
)
keywordHandler:addKeyword(
  {"captain"},
  StdModule.say,
