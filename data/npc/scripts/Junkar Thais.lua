...
local function addTravelKeyword(keyword, cost, destination)
  ...
  travelKeyword:addChildKeyword(
    {"no"},
    StdModule.say,
    {npcHandler = npcHandler, text = "Well, then you stay here, simple as that.", reset = true}
  )
end
...
keywordHandler:addKeyword(
  ...
  {
    npcHandler = npcHandler,
    text = "Where do you want me to take you? To {Kazordoon} or to {Robsons Isle}? Occasionally we can even reach the {mines} if they are cleared."
  }
)

npcHandler:setMessage(
  MESSAGE_GREET,
  "Welcome, |PLAYERNAME|! You are lucky that the service is running right now. Save your coal for the days to come though!"
)
