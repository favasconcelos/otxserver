...
local function creatureSayCallback(cid, type, msg)
  ...
  if isInArray({"addon", "outfit"}, msg) then
    if player:getStorageValue(Storage.OutfitQuest.DruidHatAddon) == 9 then
      npcHandler:say(
        "I can see in your eyes that you are a honest and friendly person, |PLAYERNAME|. You were patient enough to learn our language and I will grant you a special gift. Will you accept it?",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 1 then
    ...
    npcHandler:say(
      player:getSex() == PLAYERSEX_FEMALE and
        "From now on, you shall be known as |PLAYERNAME|, the wolf girl. You shall be fast and smart as Morgrar, the great white wolf. He shall guide your path." or
        "From now on, you shall be known as |PLAYERNAME|, the bear warrior. You shall be strong and proud as Angros, the great dark bear. He shall guide your path.",
      cid
    )
