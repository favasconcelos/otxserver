...
keywordHandler:addKeyword(
  {"stake"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I think you have forgotten to bring your stake, kid."},
  function(player)
    return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) == 5 and player:getItemCount(5941) == 0
  end
)
...
local stakeKeyword =
  ...
  function(player)
    return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) == 5
  end
)
stakeKeyword:addChildKeyword(
  ...
  {
    npcHandler = npcHandler,
    text = "So receive my prayer: 'Unclean spirits shall be repelled'. Now, bring your stake to Amanda in Edron for the next line of the prayer. I will inform her what to do.",
    reset = true
  },
  nil,
  function(player)
...
keywordHandler:addKeyword(
  {"stake"},
  StdModule.say,
  {npcHandler = npcHandler, text = "You should visit Amanda in Edron now, kid."},
  function(player)
