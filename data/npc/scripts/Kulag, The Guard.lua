...
local function creatureSayCallback(cid, type, msg)
  ...
  if
    msgcontains(msg, "trouble") and player:getStorageValue(Storage.TheInquisition.KulagGuard) < 1 and
  ...
  elseif msgcontains(msg, "authorities") then
    if npcHandler.topic[cid] == 1 then
      npcHandler:say(
        "They should throw you all into jail instead of giving you all those quests and rewards an honest watchman can only dream about.",
        cid
      )
