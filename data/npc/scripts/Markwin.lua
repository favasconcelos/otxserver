...
local function greetCallback(cid)
  ...
  elseif player:getStorageValue(Storage.MarkwinGreeting) == 1 then
    npcHandler:setMessage(
      MESSAGE_GREET,
      "Well ... you defeated my guards! Now everything is over! I guess I will have to answer your questions now."
    )
...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "cookie") then
    if
      player:getStorageValue(Storage.WhatAFoolishQuest.Questline) == 31 and
        player:getStorageValue(Storage.WhatAFoolishQuest.CookieDelivery.Markwin) ~= 1
     then
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 2 then
      ...
      npcHandler:say(
        "I understand this as a peace-offering, human ... UNGH ... THIS IS AN OUTRAGE! THIS MEANS WAR!!!",
        cid
      )
