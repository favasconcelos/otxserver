...
keywordHandler:addKeyword(
  ...
  StdModule.say,
  {
    ...
    text = "Once I was a member of the order of the nightmare knights. Now I am but a shadow who walks these cold halls."
  }
)
keywordHandler:addKeyword(
  {"boots"},
  StdModule.say,
  {npcHandler = npcHandler, text = "The north has a puzzle to complete."}
)
