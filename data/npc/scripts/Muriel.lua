...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "mission") then
    if player:getLevel() < 35 then
      npcHandler:say(
        "Indeed there is something to be done, but I need someone more experienced. Come back later if you want to.",
        cid
      )
    ...
    elseif player:getStorageValue(Storage.TibiaTales.IntoTheBonePit) == 2 then
      ...
      if player:removeItem(4864, 1) then
        ...
        npcHandler:say(
          "Excellent! Now I can try to put my theoretical thoughts into practice and find a cure for the symptoms of undead. Here, take this for your efforts.",
          cid
        )
      else
        npcHandler:say(
