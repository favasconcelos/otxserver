...
local function creatureSayCallback(cid, type, msg)
  ...
  if
    msgcontains(msg, "trouble") and player:getStorageValue(Storage.TheInquisition.GrofGuard) < 1 and
  ...
  elseif msgcontains(msg, "authorities") then
    if npcHandler.topic[cid] == 1 then
      npcHandler:say(
        "Yes I'm pretty sure they have failed to send the laundry police to take care of it, you fool.",
        cid
      )
