...
local function greetCallback(cid)
  npcHandler:setMessage(
    MESSAGE_GREET,
    "Welcome home, " .. Player(cid):getSex() == PLAYERSEX_FEMALE and "Lady" or "Sir" .. " |PLAYERNAME|."
  )
  return true
end
...
keywordHandler:addKeyword(
  {"penny"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Yep, Penny's my name. You seem to be as smart as you're talkative."}
)
keywordHandler:addKeyword(
  {"job"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I'm a secretary. I'm organising all those papers and your mail."}
)
keywordHandler:addKeyword(
  {"criminal"},
  StdModule.say,
  {npcHandler = npcHandler, text = "<Sigh> It's an evil world, isn't it?"}
)
keywordHandler:addKeyword(
  {"record"},
  StdModule.say,
