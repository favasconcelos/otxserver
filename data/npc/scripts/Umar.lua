  ...
  elseif npcHandler.topic[cid] == 1 then
    if msgcontains(msg, "yes") then
      if player:getStorageValue(Storage.DjinnWar.Faction.Efreet) ~= 1 then
        npcHandler:say(
          "Are you sure? You pledge loyalty to king Gabel, who is... you know. And you are willing to never ever set foot on Efreets' territory, unless you want to kill them? Yes?",
          cid
        )
