...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "outfit") then
    if player:getSex() == PLAYERSEX_FEMALE then
      npcHandler:say(
        "My scimitar? Well, mylady, I do not want to sound rude, but I don't think a scimitar would fit to your beautiful outfit. If you are looking for an accessory, why don't you talk to Ishina?",
        cid
      )
      return true
    end
    if player:getStorageValue(Storage.OutfitQuest.firstOrientalAddon) < 1 then
      npcHandler:say(
        "My scimitar? Yes, that is a true masterpiece. Of course I could make one for you, but I have a small request. Would you fulfil a task for me?",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 3 then
      ...
      npcHandler:say(
        "Yeah! That's it! I can't wait to give it to her! Oh - but first, I'll fulfil my promise: Here is your scimitar! Thanks again!",
        cid
      )
      npcHandler.topic[cid] = 0
    end
...
keywordHandler:addKeyword(
  ...
  StdModule.say,
  {
    ...
    text = "I sell the finest weapons in town. If you'd like to see my offers, ask me for a {trade}."
  }
)
