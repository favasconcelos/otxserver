...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "farmine") then
    if
      player:getStorageValue(Storage.TheNewFrontier.Questline) <= 15 and
        player:getStorageValue(Storage.TheNewFrontier.BribeExplorerSociety) < 1
     then
      npcHandler:say(
  ...
  elseif msgcontains(msg, "mission") then
    ...
    if
      player:getStorageValue(Storage.ExplorerSociety.QuestLine) > 3 and
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) < 26
     then
      npcHandler:say(
    ...
    elseif
      player:getStorageValue(Storage.ExplorerSociety.QuestLine) > 25 and
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) < 35
     then
    ...
    elseif
      player:getStorageValue(Storage.ExplorerSociety.QuestLine) > 34 and
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) < 44
     then
      npcHandler:say(
        "The missions available for your rank are {elven poetry}, {memory stone} and {rune writings}.",
        cid
      )
      npcHandler.topic[cid] = 0
    ...
    elseif
      player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 51 and
        player:getStorageValue(Storage.ExplorerSociety.SpectralStone) == 1
     then --##############################################
    ...
    elseif
      player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 52 and
        player:getStorageValue(Storage.ExplorerSociety.SpectralStone) == 2
     then --##############################################
      -- SPECTRAL STONE
      -- ASTRAL PORTALS
      npcHandler:say(
        "The reports from Port Hope have already arrived here and our progress is astonishing. We think it is possible to create an astral bridge between our bases. Are you interested to assist us with this?",
        cid
      )
  ...
  elseif msgcontains(msg, "pickaxe") then
    ...
    -- ICE DELIVERY
    if
      player:getStorageValue(Storage.ExplorerSociety.QuestLine) < 4 or
        player:getStorageValue(Storage.ExplorerSociety.QuestLine) > 1
     then
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 21 then
      ...
      npcHandler:say(
        "Excellent. This mission is easy but nonetheless vital. Travel to Ab'Dendriel and get the book.",
        cid
      )
      npcHandler.topic[cid] = 0
