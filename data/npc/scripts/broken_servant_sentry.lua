...
function creatureSayCallback(cid, type, msg)
  ...
  if
    (msgcontains(msg, "slime") or msgcontains(msg, "mould") or msgcontains(msg, "fungus") or msgcontains(msg, "sample"))
   then
    if (getPlayerStorageValue(cid, 47706) < 1) then
      npcHandler:say(
        "If. You. Bring. Slime. Fungus. Samples. Fro-Fro-Fro-Frrrr*chhhhchrk*From. Other. Tower. You. Must. Be. The. Master. Are. You. There. Master?",
        cid
      )
  ...
  elseif (msgcontains(msg, "cap") or msgcontains(msg, "mage")) then
    if
      (getPlayerItemCount(cid, 13756) >= 1 and getPlayerStorageValue(cid, 47706) == 2) and
        getPlayerStorageValue(cid, 47707) < 1
     then
  ...
  elseif (msgcontains(msg, "staff") or msgcontains(msg, "spike")) then
    if
      (getPlayerItemCount(cid, 13940) >= 1 and getPlayerStorageValue(cid, 47706) == 2) and
        getPlayerStorageValue(cid, 47708) < 1
     then
      npcHandler:say(
        {
  ...
  elseif (msgcontains(msg, "yes")) then
    if (npcHandler.topic[cid] == 1) then
      npcHandler:say(
        "I. Greet. You. Ma-Ma-Ma-ster! Did. You. Bring. Mo-Mo-Mo-M*chhhhrrrk*ore. Samples. For. Me. To-To-To. Analyse-lyse-lyse?",
        cid
      )
