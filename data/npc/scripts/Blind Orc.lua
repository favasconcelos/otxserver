...
local function addBuyableKeyword(keywords, itemid, amount, price, text)
  ...
  keyword:addChildKeyword(
    {"mok"},
    StdModule.say,
    {npcHandler = npcHandler, text = "Maruk rambo zambo!", reset = true},
    function(player)
...
keywordHandler:addKeyword(
  {"ikem", "goshak"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Ikem pashak porak, bata, dora. Ba goshak maruk?"}
)
keywordHandler:addKeyword(
  {"goshak", "porak"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Ikem pashak charcha, burka, burka bata, hakhak. Ba goshak maruk?"}
)
keywordHandler:addKeyword(
  {"goshak", "bata"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Ikem pashak aka bora, tulak bora, grofa. Ba goshak maruk?"}
)
keywordHandler:addKeyword(
  {"goshak", "dora"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Ikem pashak donga. Ba goshak maruk?"}
)
