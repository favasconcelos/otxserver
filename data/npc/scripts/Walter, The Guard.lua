...
local function creatureSayCallback(cid, type, msg)
  ...
  if
    (msgcontains(msg, "trouble") and player:getStorageValue(Storage.TheInquisition.WalterGuard) < 1 and
  ...
  elseif (msgcontains(msg, "avoided")) then
    if (npcHandler.topic[cid] == 2) then
      npcHandler:say(
        "You can't tell by a person's appearance who is a pickpocket and who isn't. You simply can't close the city gates for everyone.",
        cid
      )
