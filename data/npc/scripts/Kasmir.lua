...
keywordHandler:addKeyword(
  {"stake"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I think you have forgotten to bring your stake, pilgrim."},
  function(player)
...
keywordHandler:addKeyword(
  {"stake"},
  StdModule.say,
  {npcHandler = npcHandler, text = "You should visit Rahkem in Ankrahmun now, pilgrim."},
  function(player)
