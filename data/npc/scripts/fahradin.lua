...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "spy report") or msgcontains(msg, "mission") then
    if player:getStorageValue(Storage.DjinnWar.MaridFaction.Mission01) ~= 2 then
      npcHandler:say(
        "Looking for work, are you? Well, it's very tempting, you know, but I'm afraid we do not really employ beginners. Perhaps our cook could need a helping hand in the kitchen.",
        cid
      )
    ...
    elseif missionProgress == 1 then
      ...
      npcHandler:say(
        "Did you already talk to Gabel about the report? I think he will have further instructions for you.",
        cid
      )
    end
...
npcHandler:setMessage(
  MESSAGE_GREET,
  "Aaaah... what have we here. A human - interesting. And such an ugly specimen, too... All right, human |PLAYERNAME|. How can I help you?"
)
