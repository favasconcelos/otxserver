...
node1:addChildKeyword(
  ...
  {npcHandler = npcHandler, premium = true, cost = 20000, level = 20, text = "Congratulations! You are now promoted."}
)
node1:addChildKeyword(
  {"no"},
  StdModule.say,
...
local bribeKeyword =
  ...
  {
    npcHandler = npcHandler,
    text = "Ah, I vaguely remember that our little allies were eager to build some base. So speak up, what do you want?"
  },
  function(player)
    return player:getStorageValue(Storage.TheNewFrontier.Questline) <= 15
  end
)
bribeKeyword:addChildKeyword(
  {"flatter"},
  StdModule.say,
  {
    npcHandler = npcHandler,
    text = "Indeed, indeed. Without the help of Thais, our allies stand no chance! Well, I'll send some money to support their cause.",
    reset = true
  },
  function(player)
    return player:getStorageValue(Storage.TheNewFrontier.BribeKing) ~= 1
  end,
  function(player)
    player:setStorageValue(Storage.TheNewFrontier.BribeKing, 1)
    player:setStorageValue(
      Storage.TheNewFrontier.Mission05,
...
keywordHandler:addKeyword(
  {"name"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Preposterous! You must know the name of your own King!"}
)
keywordHandler:addKeyword(
  {"news"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"sell"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Sell? Sell what? My kingdom isn't for sale!"}
)
keywordHandler:addKeyword(
  {"god"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Honour the Gods and above all pay your {taxes}."}
)
keywordHandler:addKeyword(
  {"zathroth"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Please ask a priest about the gods."}
)
keywordHandler:addKeyword(
  {"citizen"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"sam"},
  StdModule.say,
  {npcHandler = npcHandler, text = "He is a skilled blacksmith and a loyal subject."}
)
keywordHandler:addKeyword(
  {"frodo"},
  StdModule.say,
  {npcHandler = npcHandler, text = "He is the owner of Frodo's Hut and a faithful tax-payer."}
)
keywordHandler:addKeyword(
  {"gorn"},
  StdModule.say,
  {npcHandler = npcHandler, text = "He was once one of Tibia's greatest fighters. Now he sells equipment."}
)
keywordHandler:addKeyword(
  {"benjamin"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"noodles"},
  StdModule.say,
  {npcHandler = npcHandler, text = "The royal poodle Noodles is my greatest {treasure}!"}
)
keywordHandler:addKeyword(
  {"ferumbras"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"bozo"},
  StdModule.say,
  {npcHandler = npcHandler, text = "He is my royal jester and cheers me up now and then."}
)
keywordHandler:addKeyword(
  {"treasure"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"monster"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Go and hunt them! For king and country!"}
)
...
keywordHandler:addKeyword(
  {"dungeon"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Dungeons are no places for kings."}
)
keywordHandler:addKeyword(
  {"equipment"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Feel free to buy it in our town's fine shops."}
)
keywordHandler:addKeyword(
  {"food"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Ask the royal cook for some food."}
)
keywordHandler:addKeyword(
  {"tax collector"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"king"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I am the king, so watch what you say!"}
)
keywordHandler:addKeyword({"army"}, StdModule.say, {npcHandler = npcHandler, text = "Ask the soldiers about that."})
keywordHandler:addKeyword(
  {"shop"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Visit the shops of our merchants and craftsmen."}
)
keywordHandler:addKeyword(
  {"guild"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"good"},
  StdModule.say,
  {npcHandler = npcHandler, text = "The forces of good are hard pressed in these dark times."}
)
keywordHandler:addKeyword(
  {"evil"},
  StdModule.say,
  {npcHandler = npcHandler, text = "We need all strength we can muster to smite evil!"}
)
...
keywordHandler:addKeyword(
  {"reward"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Well, if you want a reward, go on a quest to bring me Excalibug!"}
)
keywordHandler:addKeyword(
  {"chester"},
  StdModule.say,
  {npcHandler = npcHandler, text = "A very competent person. A little nervous but very competent."}
)
keywordHandler:addKeyword(
  {"tbi"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"tibia"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Soon the whole land will be ruled by me once again!"}
)
keywordHandler:addAliasKeyword({"land"})
keywordHandler:addKeyword(
  {"harkath"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Harkath Bloodblade is the general of our glorious {army}."}
)
...
keywordHandler:addKeyword(
  {"gold"},
  StdModule.say,
  {npcHandler = npcHandler, text = "To pay your taxes, visit the royal tax collector."}
)
...
keywordHandler:addKeyword(
  {"carlin"},
  StdModule.say,
  {npcHandler = npcHandler, text = "They dare to reject my reign over the whole continent!"}
)
keywordHandler:addKeyword(
  {"thais"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Our beloved city has some fine shops, guildhouses and a modern sewerage system."}
)
...
keywordHandler:addKeyword(
  {"paladin"},
  StdModule.say,
  {npcHandler = npcHandler, text = "The paladins are great protectors for Thais."}
)
keywordHandler:addAliasKeyword({"elane"})
keywordHandler:addKeyword(
  {"knight"},
  StdModule.say,
  {npcHandler = npcHandler, text = "The brave knights are necessary for human survival in Thais."}
)
keywordHandler:addAliasKeyword({"gregor"})
keywordHandler:addKeyword(
  {"sorcerer"},
  StdModule.say,
  {npcHandler = npcHandler, text = "The magic of the sorcerers is a powerful tool to smite our enemies."}
)
keywordHandler:addAliasKeyword({"muriel"})
keywordHandler:addKeyword(
  {"druid"},
  StdModule.say,
  {npcHandler = npcHandler, text = "We need the druidic healing powers to fight evil."}
)
