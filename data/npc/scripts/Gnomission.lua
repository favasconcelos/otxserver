...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif (msgcontains(msg, "job")) then
    if player:getStorageValue(Storage.BigfootBurden.QuestLine) == 17 then
      npcHandler:say(
        "I am responsible for our war missions, to trade with seasoned soldiers and rewarding war heroes. You have to be rank 4 to enter the warzones.",
        cid
      )
  ...
  elseif (msgcontains(msg, "mission")) then
    if (npcHandler.topic[cid] == 1) then
      npcHandler:say(
        "Fine, I grant you the permission to enter the warzones. Be warned though, this will be not a picnic. Better bring some friends with you. Bringing a lot of them sounds like a good idea.",
        cid
      )
