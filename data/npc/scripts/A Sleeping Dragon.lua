...
local function creatureSayCallback(cid, type, msg)
  ...
  if player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 27 then
    ...
    elseif (msg:lower() == "south" and npcHandler.topic[cid] == 4) then
      npcHandler:say(
        "You wander to the south, passing large obelisks of emerald to your left and sprawling trees of topaz to your right. ",
        cid
      )
      npcHandler.topic[cid] = 5
    elseif (msg:lower() == "take stand" and npcHandler.topic[cid] == 5) then
      npcHandler:say(
        "As you rip the solid stand out of its socket and take it with you, the large gate opens with a deafening rumble. ",
        cid
      )
      npcHandler.topic[cid] = 6
    elseif (msg:lower() == "east" and npcHandler.topic[cid] == 6) then
      npcHandler:say(
        "You gasp at the size of the large open gate as you walk through to head further to the east.",
        cid
      )
      npcHandler.topic[cid] = 7
    elseif (msg:lower() == "take model" and npcHandler.topic[cid] == 7) then
      npcHandler:say(
        "You reach for a small solitary arrangement of combined small houses and put it in your pocket.",
        cid
      )
    ...
    elseif (msg:lower() == "east" and npcHandler.topic[cid] == 11) then
      npcHandler:say(
        "You travel east across several large emerald bluffs and edges. All sorts of gems are scattered alongside your path. ",
        cid
      )
    ...
    elseif (msg:lower() == "bastesh" and npcHandler.topic[cid] == 24) then
      npcHandler:say(
        "This huge statue of Bastesh is made from onyx, and thrones on a large plateau which can be reached by a sprawling stairway. She holds a large {sapphire} in her hands. ",
        cid
      )
  ...
  elseif player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 28 then
    if (msgcontains(msg, "wayfarer")) then
      npcHandler:say(
        "I call you the wayfarer. You travelled through my dreams. You ultimately freed my mind. My mind accepted you and so will I.",
        cid
      )
