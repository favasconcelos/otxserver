...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "money") then
    if npcHandler.topic[cid] == 2 then
      npcHandler:say(
        "I thought so. Okay, I will roll a dice. If it shows 6, you will get five times your bet. How much do you want to bet?",
        cid
      )
  ...
  elseif msgcontains(msg, "dice") then
    if npcHandler.topic[cid] == 2 then
      npcHandler:say(
        "Hehe, good choice. Okay, the price for this game is 100 gold pieces. I will roll a dice. If I roll a 6, you can have my dice. Agreed?",
        cid
      )
  ...
  elseif tonumber(msg) then
    ...
    if amount < 1 or amount > 99 then
      npcHandler:say(
        "I am sorry, but I accept only bets between 1 and 99 gold. I don't want to ruin you after all. How much do you want to bet?",
        cid
      )
      npcHandler.topic[cid] = 3
      return false
