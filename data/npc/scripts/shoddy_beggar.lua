...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "yes") then
    if npcHandler.topic[cid] == 1 then
      if not player:removeMoneyNpc(1) then
        npcHandler:say(
          player:getStorageValue(Storage.SeaOfLightQuest.Questline) ~= 1 and
            "Is that all you have? That would be less than I have... *mumbles*" or
            "Mh, it seems you don't have any coins.",
          cid
        )
      ...
      npcHandler:say(
        player:getStorageValue(Storage.SeaOfLightQuest.Questline) ~= 1 and
          "Very kind indeed. Maybe you are not such a bad guy after all. Maybe I can even give it back to you one day... you know I was not always like that *mumbles*." or
    ...
    elseif npcHandler.topic[cid] == 8 then
      npcHandler:say(
        "Right... I'm glad everything was destroyed. I don't even know why I kept the remaining copy of the plans all those years... oh, did I say this aloud?",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 10 then
      npcHandler:say(
        "Ah, you think you are wise but you know nothing, nothing about science, nothing about the opportunities it offers... You will never understand scientists like me.",
        cid
      )
      npcHandler.topic[cid] = 0
  ...
  elseif msgcontains(msg, "no") then
    ...
    elseif npcHandler.topic[cid] == 5 then
      npcHandler:say(
        "Yes and I, I... you mean what? Can't imagine? Well, then there is no purpose to continue telling you this story.",
        cid
      )
      npcHandler.topic[cid] = 0
    elseif npcHandler.topic[cid] == 6 then
    ...
    elseif npcHandler.topic[cid] == 8 then
      npcHandler:say(
        "No, no, you are right, I should have tried to rebuild it, I should have been more careful, I should... ah, why did I even tell you this.",
        cid
      )
      npcHandler.topic[cid] = 0
    elseif npcHandler.topic[cid] == 9 then
