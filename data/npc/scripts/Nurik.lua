...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "dwarven bridge") then
    npcHandler:say(
      "Wait a minute! Do I get that right? You're the owner of the dwarven bridge and you are willing to sell it to me??",
      cid
    )
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 3 then
      npcHandler:say(
        "Oh my, oh my. I'm so excited! So let's seal this deal as fast as possible so I can visit my very own dwarven bridge. Are you ready for the transaction?",
        cid
      )
...
npcHandler:setMessage(
  MESSAGE_GREET,
  "It's .. It's YOU! At last!! So what's this special proposal you would like to make, my friend?"
)
