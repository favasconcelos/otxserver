...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "cookie") then
    if
      player:getStorageValue(Storage.WhatAFoolishQuest.Questline) == 31 and
        player:getStorageValue(Storage.WhatAFoolishQuest.CookieDelivery.SimonTheBeggar) ~= 1
     then
  ...
  elseif msgcontains(msg, "yes") then
    if npcHandler.topic[cid] == 1 then
      ...
      npcHandler:say(
        "Well, it's the least you can do for those who live in dire poverty. A single cookie is a bit less than I'd expected, but better than ... WHA ... WHAT?? MY BEARD! MY PRECIOUS BEARD! IT WILL TAKE AGES TO CLEAR IT OF THIS CONFETTI!",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 2 then
      ...
      npcHandler:say(
        "Thank you very much. Can you spare 500 more gold pieces for me? I will give you a nice hint.",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 3 then
      ...
      npcHandler:say(
        "That's great! I have stolen something from Dermot. You can buy it for 200 gold. Do you want to buy it?",
        cid
      )
...
node1 =
  ...
  StdModule.say,
  {
    ...
    text = "For the small fee of 20000 gold pieces I will help you mix this potion. Just bring me 100 pieces of ape fur, which are necessary to create this potion. ...Do we have a deal?"
  }
)
...
node1:addChildKeyword(
  {"no"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Alright then. Come back when you got all neccessary items.", reset = true}
)
