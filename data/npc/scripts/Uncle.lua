...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 2 then
      ...
      npcHandler:say(
        "I hope you did not make this little pest too nervous. He isn't serving us too well by hiding under some stone or something like that. However, nicely done for your first job.",
        cid
      )
      npcHandler.topic[cid] = 0
    ...
    elseif npcHandler.topic[cid] == 4 then
      ...
      npcHandler:say(
        "Does it not warm up your heart if you can bring a little joy to the people while doing your job? Well, don't get carried away, most part of your job is not warming up hearts but tearing them out.",
        cid
      )
      npcHandler.topic[cid] = 0
    ...
    elseif npcHandler.topic[cid] == 6 then
      if player:removeItem(7708, 1) then
        ...
        npcHandler:say(
          "Fine, fine. This will serve us quite well. Ah, don't give me that look... you are not that stupid, are you?",
          cid
        )
      else
    ...
    elseif npcHandler.topic[cid] == 7 then
      ...
      npcHandler:say(
        "Even if the present has not improved our relations, the weapons will enable the barbarians to put more pressure on Svargrond and Carlin. So in any case we profited from the present.",
        cid
      )
      npcHandler.topic[cid] = 0
  ...
  elseif msgcontains(msg, "mission") then
    if
      player:getStorageValue(Storage.secretService.Quest) == 1 and
        player:getStorageValue(Storage.secretService.TBIMission01) < 1 and
     ...
     then
      ...
      npcHandler:say(
        "Let's start with a rather simple job. There is a contact in Thais with that we need to get in touch again. Deliver this note to Gamel in Thais. Get an answer from him. If he is a bit reluctant, be 'persuasive'.",
        cid
      )
      npcHandler.topic[cid] = 0
    ...
    elseif
      player:getStorageValue(Storage.secretService.AVINMission01) == 4 and
    ...
    elseif
      player:getStorageValue(Storage.secretService.AVINMission02) == 2 and
    ...
    elseif
      player:getStorageValue(Storage.secretService.AVINMission03) == 4 and
    ...
    elseif
      player:getStorageValue(Storage.secretService.AVINMission04) == 3 and
     ...
     then
      ...
      npcHandler:say(
        "I need you to locate a lost ring on the Isle of the Kings for me, get back to me once you have it.",
        cid
      )
      npcHandler.topic[cid] = 0
    ...
    elseif
      player:getStorageValue(Storage.secretService.AVINMission05) == 2 and
    ...
    elseif
      player:getStorageValue(Storage.secretService.AVINMission06) == 3 and
