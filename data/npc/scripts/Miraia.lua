...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "outfit") then
    npcHandler:say(
      player:getSex() == PLAYERSEX_FEMALE and
        "Hehe, would you like to wear a pretty veil like I do? Well... I could help you, but you would have to complete a task first." or
        "My veil? No, I will definitely not lift it for you! If you are looking for an addon, go talk to Razan.",
      cid
    )
  elseif msgcontains(msg, "task") then
    if player:getSex() == PLAYERSEX_MALE then
      npcHandler:say(
        "Uh... I don't think that I have work for you right now. If you need a job, go talk to Razan.",
        cid
      )
      return true
    end
  ...
  elseif msgcontains(msg, "scarab cheese") then
    if player:getStorageValue(Storage.TravellingTrader.Mission03) == 1 then
      npcHandler:say(
        "Let me cover my nose before I get this for you... Would you REALLY like to buy scarab cheese for 100 gold?",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 3 then
      ...
      player:setStorageValue(
        Storage.OutfitQuest.secondOrientalAddon,
        player:getStorageValue(Storage.OutfitQuest.secondOrientalAddon) + 1
      )
...
npcHandler:setMessage(
  MESSAGE_GREET,
  "Daraman's blessings, |PLAYERNAME|. Welcome to the Enlightened Oasis. Sit down, have a {drink} or some {food}!"
)
