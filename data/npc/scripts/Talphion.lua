  ...
  if msgcontains(msg, "dress pattern") then
    if player:getStorageValue(Storage.postman.Mission06) == 3 then
      ...
      elseif npcHandler.topic[cid] == 4 then
        npcHandler:say(
          "AH YES! I WORKED ON THE DRESS PATTERN FOR THOSE UNIFORMS. STAINLESS TROUSERES, STEAM DRIVEN BOOTS! ANOTHERMARVEL TO BEHOLD! I'LL SENT A COPY TO KEVIN IMEDIATELY!",
          cid
        )
