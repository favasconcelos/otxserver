...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "mission") then
    if player:getStorageValue(Storage.TibiaTales.AgainstTheSpiderCult) < 1 then
      ...
      npcHandler:say(
        "Very good, we need heroes like you to go on a suici.....er....to earn respect of the authorities here AND in addition get a great reward for it. Are you interested in the job?",
        cid
      )
    elseif player:getStorageValue(Storage.TibiaTales.AgainstTheSpiderCult) == 5 then
      ...
      npcHandler:say(
        "What? YOU DID IT?!?! That's...that's...er....<drops a piece of paper. You see the headline 'death certificate'> like I expected!! Here is your reward.",
        cid
      )
    end
...
keywordHandler:addKeyword(
  ...
  StdModule.say,
  {
    ...
    text = "I am the governor of this isle, Edron, and grandmaster of the Knights of Banor's Blood."
  }
)
