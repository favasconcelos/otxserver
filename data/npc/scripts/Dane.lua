...
keywordHandler:addKeyword(
  {"job"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I am the owner of this place of relaxation."}
)
...
keywordHandler:addKeyword(
  {"offer"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I can offer you milk, water, and lemonade."}
)
keywordHandler:addKeyword(
  {"alcohol"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Alcohol makes people too aggressive. We don't need such stuff in Carlin."}
)
keywordHandler:addKeyword(
  {"beer"},
  StdModule.say,
