...
local function greetCallback(cid)
  if Player(cid):getSex() == PLAYERSEX_FEMALE then
    ...
    npcHandler:setMessage(
      MESSAGE_GREET,
      "Oh, hello, handsome! It's a pleasure to meet you, |PLAYERNAME|. Gladly I have the time to {chat} a bit."
    )
...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "job") or msgcontains(msg, "chat") then
    npcHandler:say(
      "I do some work now and then. Nothing unusual, though. So I have plenty time to chat. If you are interested in any topic just ask me.",
      cid
    )
    npcHandler.topic[cid] = 2
    Price[cid] = 5
  ...
  elseif msgcontains(msg, "monster") or msgcontains(msg, "dungeon") then
    npcHandler:say(
      "UH! What a terrifying topic. Please let us speak about something more pleasant, I am a weak and small woman after all.",
      cid
    )
    npcHandler.topic[cid] = 2
    Price[cid] = 5
  ...
  elseif msgcontains(msg, "king") then
    npcHandler:say(
      "The king, that lives in this fascinating castle? I think he does look kind of cute in his luxurious robes, doesn't he?",
      cid
    )
    npcHandler.topic[cid] = 2
    Price[cid] = 10
  elseif msgcontains(msg, "sam") then
    if Sex == PLAYERSEX_FEMALE then
      ...
      npcHandler:say(
        "He is soooo strong! What muscles! What a body! On the other hand, compared to you he looks quite puny.",
        cid
      )
    end
    npcHandler.topic[cid] = 2
  ...
  elseif msgcontains(msg, "gorn") then
    npcHandler:say(
      "He should really sell some stylish gowns or something like that. We Tibians never get some clothing of the latest fashion. It's a shame.",
      cid
    )
    npcHandler.topic[cid] = 2
    Price[cid] = 5
  ...
  elseif msgcontains(msg, "elane") then
    npcHandler:say(
      "I personally think it's inappropriate for a woman to become a warrior, what do you think about that?",
      cid
    )
    npcHandler.topic[cid] = 2
    Price[cid] = 5
  ...
  elseif msgcontains(msg, "yenny") then
    npcHandler:say(
      "Yenny? I know no Yenny, nor have I ever used that name! You have mistook me with someone else.",
      cid
    )
    npcHandler.topic[cid] = nil
    Price[cid] = nil
