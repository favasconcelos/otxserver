...
local function greetCallback(cid)
  ...
  if not player:removeItem(2787, 1) then
    npcHandler:say(
      "AHHHH THE PAIN OF AGESSS! I NEED MUSSSSHRROOOMSSS TO EASSSE MY PAIN! BRRRING ME MUSHRRROOOMSSS!",
      cid
    )
    return false
  end
  ...
  npcHandler:say(
    "AHHH MUSHRRROOOMSSS! NOW MY PAIN WILL BE EASSSED FOR A WHILE! TAKE THISS AND LEAVE THE DRAGONSSS' CEMETERY AT ONCE!",
    cid
  )
  return false
end
