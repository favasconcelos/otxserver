...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "mission") then
    ...
    elseif qStorage == 2 then
      npcHandler:say(
        {
          "So you have passed Spectulus' acceptance test. Well, I'm sure you will live up to that. ...",
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 5 then
      npcHandler:say(
        "Good, of course you will also receive an additional monetary reward for your troubles. Are you fine with that?",
        cid
      )
      npcHandler.topic[cid] = 6
    elseif npcHandler.topic[cid] == 6 then
      local nightstalkers, souleaters, ghost =
        player:getStorageValue(Storage.spiritHuntersQuest.nightstalkerUse),
        player:getStorageValue(Storage.spiritHuntersQuest.souleaterUse),
        player:getStorageValue(Storage.spiritHuntersQuest.ghostUse)
...
npcHandler:setMessage(
  MESSAGE_GREET,
  "Greetings |PLAYERNAME|. I have - very - little time, please make it as short as possible. I may be able to help you if you are here to help us with any of our tasks or missions."
)
