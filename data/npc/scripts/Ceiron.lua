...
local function creatureSayCallback(cid, type, msg)
  ...
  if isInArray({"addon", "outfit"}, msg) then
    if player:getStorageValue(Storage.OutfitQuest.DruidHatAddon) < 1 then
      npcHandler:say(
        "What are you thinking! I would never allow you to slay my beloved friends for the sake of your narcism. Only {Faolan} can grant you a fur like this one.",
        cid
      )
  ...
  elseif msgcontains(msg, "faolan") then
    if npcHandler.topic[cid] == 2 then
      npcHandler:say(
        "I know where the great wolf mother lives, but I will not tell that to just anyone. You have to earn my respect first. Are you willing to help me?",
        cid
      )
      npcHandler.topic[cid] = 3
    elseif player:getStorageValue(Storage.OutfitQuest.DruidHatAddon) == 8 then
      npcHandler:say(
        "Right, I will keep my promise. Faolan roams Tibia freely, but her favourite sleeping cave is on Cormaya. I will now enchant you so you will be able to speak the wolf language.",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 4 then
      npcHandler:say(
        "Alright then. Take this botanist's container and return to me once you were able to retrieve a sample. Don't lose patience!",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 5 then
      if player:removeItem(5937, 1) then
        npcHandler:say(
          "Crunor be praised! The Griffinclaw really exists! Now, I will make sure that it will not become extinct. If you are ready to help me again, just ask me for a {task}.",
          cid
        )
    ...
    elseif npcHandler.topic[cid] == 6 then
      npcHandler:say(
        "Great! Here, take my waterskin and try to fill it with water from this special trickle. Don't lose my waterskin, I will not accept some random dirty waterskin.",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 7 then
      if player:removeItem(5939, 1) then
        npcHandler:say(
          "Good work, |PLAYERNAME|! This water looks indeed extremely clear. I will examine it right away. If you are ready to help me again, just ask me for a {task}.",
          cid
        )
    ...
    elseif npcHandler.topic[cid] == 9 then
      if player:removeItem(5906, 100) then
        npcHandler:say(
          "I'm very impressed, |PLAYERNAME|. With this task you have proven that you are on the right side and are powerful as well. If you are ready to help me again, just ask me for a {task}.",
          cid
        )
    ...
    elseif npcHandler.topic[cid] == 10 then
      npcHandler:say(
        "Thank you so much. I can't wait to wear it around my neck again, it was a special present from Faolan.",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 11 then
      if player:removeItem(5940, 1) then
        npcHandler:say(
          "Crunor be praised! You found my beloved chain! |PLAYERNAME|, you really earned my respect and I consider you as a friend from now on. Remind me to tell you about {Faolan} sometime.",
          cid
        )
    ...
    elseif npcHandler.topic[cid] == 12 then
      npcHandler:say(
        "I can give you a new one, but I fear that I have to take a small fee for it. Would you like to buy a waterskin for 1000 gold?",
        cid
      )
