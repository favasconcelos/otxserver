...
keywordHandler:addKeyword(
  {"job"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I'm a merchant. Just ask me for a {trade} to see my offers."}
)
keywordHandler:addKeyword(
  {"name"},
  StdModule.say,
  {npcHandler = npcHandler, text = "My name is Al Dee, but you can call me Al. Can I interest you in a {trade}?"}
)
keywordHandler:addKeyword(
  {"time"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"bug"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Bugs plague this isle, but my wares are bug-free, totally bug-free."}
)
keywordHandler:addKeyword(
  {"tibia"},
  StdModule.say,
  {npcHandler = npcHandler, text = "One day I will return to the continent as a rich, a very rich man!"}
)
...
keywordHandler:addKeyword(
  {"cooki"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I you want to find someone who may want to buy your cookies, you should meet Lily."}
)
keywordHandler:addKeyword(
  {"blueberr"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"potion"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Sorry, I don't sell potions. You should visit {Lily} for that."}
)
keywordHandler:addKeyword(
  {"food"},
  StdModule.say,
...
keywordHandler:addKeyword(
  {"torch"},
  StdModule.say,
  {npcHandler = npcHandler, text = "No thank you. I can already overstock the market with torches."}
)
keywordHandler:addKeyword(
  {"fishing"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I sell fishing rods and worms if you want to fish. Simply ask me for a {trade}."}
)
keywordHandler:addKeyword(
  {"shovel"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Yes, I am selling that. Simply ask me for a {trade} to view all my offers."}
)
...
keywordHandler:addKeyword(
  {"al", "dee"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Yep, that's me. Smart of you to notice that!"}
)
...
keywordHandler:addKeyword(
  {"zerbrus"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Some call him a hero. He protects the town from {monsters}."}
)
...
pickKeyword:addChildKeyword(
  {"yes"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Splendid! Here, take your pick.", reset = true},
  function(player)
    return player:getItemCount(2559) > 0
  end,
  function(player)
...
pickKeyword:addChildKeyword(
  {"yes"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Sorry, I am looking for a SMALL axe.", reset = true}
)
