...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "Ab'Dendriel") then
    if
      player:getStorageValue(Storage.SearoutesAroundYalahar.AbDendriel) ~= 1 and
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) < 5
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.SearoutesAroundYalahar.AbDendriel) == 1 or
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) >= 5
     then
      npcHandler:say(
        {
  ...
  elseif msgcontains(msg, "Darashia") then
    if
      player:getStorageValue(Storage.SearoutesAroundYalahar.Darashia) ~= 1 and
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) < 5
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.SearoutesAroundYalahar.Darashia) == 1 or
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) >= 5
     then
      npcHandler:say(
        {
  ...
  elseif msgcontains(msg, "Venore") then
    if
      player:getStorageValue(Storage.SearoutesAroundYalahar.Venore) ~= 1 and
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) < 5
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.SearoutesAroundYalahar.Venore) == 1 or
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) >= 5
     then
      npcHandler:say(
        {
          "The swamp spice will turn out very lucrative considering that it helps to make even the most disgusting dish taste good. Do you want a passage to Venore for 185 gold?"
        },
        cid
      )
  ...
  elseif msgcontains(msg, "Ankrahmun") then
    if
      player:getStorageValue(Storage.SearoutesAroundYalahar.Ankrahmun) ~= 1 and
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) < 5
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.SearoutesAroundYalahar.Ankrahmun) == 1 or
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) >= 5
     then
      npcHandler:say(
        {
  ...
  elseif msgcontains(msg, "Port Hope") then
    if
      player:getStorageValue(Storage.SearoutesAroundYalahar.PortHope) ~= 1 and
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) < 5
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.SearoutesAroundYalahar.PortHope) == 1 or
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) >= 5
     then
      npcHandler:say(
        {
  ...
  elseif msgcontains(msg, "Thais") then
    if
      player:getStorageValue(Storage.SearoutesAroundYalahar.Thais) ~= 1 and
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) < 5
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.SearoutesAroundYalahar.Thais) == 1 or
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) >= 5
     then
      npcHandler:say(
        {
  ...
  elseif msgcontains(msg, "Liberty Bay") then
    if
      player:getStorageValue(Storage.SearoutesAroundYalahar.LibertyBay) ~= 1 and
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) < 5
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.SearoutesAroundYalahar.LibertyBay) == 1 or
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) >= 5
     then
      npcHandler:say(
        {
  ...
  elseif msgcontains(msg, "Carlin") then
    if
      player:getStorageValue(Storage.SearoutesAroundYalahar.Carlin) ~= 1 and
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) < 5
     then
      npcHandler:say(
        {
    ...
    elseif
      player:getStorageValue(Storage.SearoutesAroundYalahar.Carlin) == 1 or
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) >= 5
     then
      npcHandler:say(
        {
  ...
  elseif msgcontains(msg, "yes") then
    if npcHandler.topic[cid] == 1 and player:removeItem(9674, 1) then
      ...
      player:setStorageValue(
        Storage.SearoutesAroundYalahar.TownsCounter,
        player:getStorageValue(Storage.SearoutesAroundYalahar.TownsCounter) + 1
      )
      npcHandler.topic[cid] = 0
    ...
    elseif npcHandler.topic[cid] == 7 and player:removeItem(5553, 1, 27) then
      npcHandler:say(
        "I doubt that the esteemed Yalahari will indulge into something profane as rum. But who knows, I'll give it a try.",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 8 and player:removeItem(11428, 1) then
      npcHandler:say(
        "I doubt that these flowers will stay fresh and healthy forever. But if they do, they could be indeed valuable.",
        cid
      )
...
keywordHandler:addKeyword(
  {"captain"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I am the captain of this ship."}
)
keywordHandler:addKeyword(
  {"name"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I'm Karith. I don't belong to a caste any longer, and only serve the Yalahari."}
)
keywordHandler:addKeyword(
  {"yalahar"},
  StdModule.say,
