...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "test") then
    if player:getStorageValue(Storage.thievesGuild.Mission04) == 5 then
      npcHandler:say(
        "I hope you learnt your role! I'll tell you a line from the script and you'll have to answer with the corresponding line! Ready?",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") then
    if npcHandler.topic[cid] == 1 then
      npcHandler:say(
        "How dare you? Are you mad? I hold the princess hostage and you drop your weapons. You're all lost!",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 11 then
      npcHandler:say(
        "Ah well, I think you passed the test! Here is your disguise kit! Now get lost, fate awaits me!",
        cid
      )
