...
local function creatureSayCallback(cid, type, msg)
  ...
  if (msgcontains(msg, "fight")) then
    npcHandler:say(
      "Do you really want to enter the Lisa's hideout. There is no chickening out and I also have to charge one voting right! {Yes} or {no}?",
      cid
    )
