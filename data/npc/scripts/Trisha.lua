...
local function creatureSayCallback(cid, type, msg)
  ...
  if npcHandler.topic[cid] == 0 then
    if isInArray({"outfit", "addon"}, msg) then
      npcHandler:say(
        "Are you talking about my spiky shoulder pad? You can't buy one of these. They have to be {earned}.",
        cid
      )
    elseif msgcontains(msg, "earn") then
      if player:getStorageValue(storage) < 1 then
        npcHandler:say(
          "I'm not sure if you are enough of a hero to earn them. You could try, though. What do you think?",
          cid
        )
      ...
      elseif player:getStorageValue(storage) == 5 then
        npcHandler:say(
          "You did it! I have seldom seen a man as courageous as you. I really have to say that you deserve to wear a spike. Go ask Cornelia to adorn your armour.",
          cid
        )
      end
