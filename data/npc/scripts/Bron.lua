...
local function greetCallback(cid)
  ...
  if player:getStorageValue(Storage.OutfitQuest.BarbarianAddon) == 6 then
    npcHandler:setMessage(
      MESSAGE_GREET,
      "Oh no! Was that really me? This is so embarassing, I have no idea what has gotten into me. Was that the fighting spirit you gave me?"
    )
  end
  return true
end
...
keywordHandler:addKeyword(
  ...
  StdModule.say,
  {
    ...
    text = "This... person... makes me want to... say something bad... must... control myself. <sweats>"
  }
)
...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif (msgcontains(msg, "fist")) then
    if player:getStorageValue(Storage.OutfitQuest.BarbarianAddon) == 3 then
      npcHandler:say(
        "Oh! He really said that? I am so proud of you, |PLAYERNAME|. These are really good news. Everything would be great... if only there wasn't this {person} near my house.",
        cid
      )
  ...
  elseif (msgcontains(msg, "fighting spirit")) then
    if player:getStorageValue(Storage.OutfitQuest.BarbarianAddon) == 5 then
      if player:removeItem(5884, 1) then
        ...
        npcHandler:say(
          "Fighting spirit? What am I supposed to do with this fi... - oh! I feel strange... ME MIGHTY! ME WILL CHASE OFF ANNOYING KIDS!GROOOAARR!! RRRRRRRRRRRRAAAAAAAGE!!",
          cid
        )
  ...
  elseif (msgcontains(msg, "cloth")) then
    if player:getStorageValue(Storage.OutfitQuest.BarbarianAddon) == 7 then
      npcHandler:say(
        "Have you really managed to fulfil the task and brought me 50 pieces of red cloth and 50 pieces of green cloth?",
        cid
      )
  ...
  elseif (msgcontains(msg, "yes")) then
    ...
    elseif (npcHandler.topic[cid] == 2) then
      npcHandler:say(
        "You are indeed not only well educated, but also very courageous. I wish you good luck, you are my last hope.",
        cid
      )
    ...
    elseif (npcHandler.topic[cid] == 4) then
      npcHandler:say(
        "Again, I have to thank you for your selfless offer to help me. I hope that Ajax can come up with something, now that he has experienced the power of words.",
        cid
      )
    ...
    elseif (npcHandler.topic[cid] == 7) then
      npcHandler:say(
        "Thank you, my friend! Come back to me once you have collected 50 pieces of red cloth and 50 pieces of green cloth.",
        cid
      )
    ...
    elseif (npcHandler.topic[cid] == 8) then
      if player:getItemCount(5910) >= 50 and player:getItemCount(5911) >= 50 then
        npcHandler:say(
          "Terrific! I will start to trim it while you gather 10 rolls of spider silk. I'm sure that Ajax will love it.",
          cid
        )
    ...
    elseif (npcHandler.topic[cid] == 9) then
      if player:removeItem(5886, 10) then
        npcHandler:say(
          "I'm impressed! You really managed to get spider silk yarn for me! I will immediately start to work on this shirt. Please don't forget to bring me warrior's sweat!",
          cid
        )
    ...
    elseif (npcHandler.topic[cid] == 10) then
      if player:removeItem(5885, 1) then
        npcHandler:say(
          "Good work, |PLAYERNAME|! Now I can finally finish this present for Ajax. Because you were such a great help, I have also a present for you. Will you accept it?",
          cid
        )
    ...
    elseif player:getStorageValue(Storage.OutfitQuest.BarbarianAddon) == 10 then
      npcHandler:say(
        "I have kept this traditional barbarian wig safe for many years now. It is now yours! I hope you will wear it proudly, friend.",
        cid
      )
