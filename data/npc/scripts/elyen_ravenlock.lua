...
local function creatureSayCallback(cid, type, msg)
  ...
  if
    (msgcontains(msg, "scroll") or msgcontains(msg, "mission")) and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission60) == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission61) < 1
   then
  ...
  elseif
    msgcontains(msg, "yes") and npcHandler.topic[cid] == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission60) == 1
   then
  ...
  elseif
    (msgcontains(msg, "artefact") or msgcontains(msg, "yes")) and npcHandler.topic[cid] == 2 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission60) == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission61) < 1
   then
    npcHandler:say(
  ...
  elseif
    (msgcontains(msg, "agreed") or msgcontains(msg, "yes")) and npcHandler.topic[cid] == 3 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission60) == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission61) < 1
   then
    npcHandler:say(
  ...
  elseif
    msgcontains(msg, "mission") and player:getStorageValue(Storage.GravediggerOfDrefia.Mission66) == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission67) < 1
   then
    npcHandler:say("Hello, brother. You have finished the dance?", cid)
    npcHandler.topic[cid] = 4
  elseif
    (msgcontains(msg, "yes")) and npcHandler.topic[cid] == 4 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission66) == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission67) < 1
   then
    npcHandler:say(
      {
    ...
    npcHandler:say({"Time is money, hurry."}, cid)
  end
  return true
end
