...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "mission") then
    ...
    elseif player:getStorageValue(Storage.ChildrenoftheRevolution.Questline) == 7 then
      if
        player:getStorageValue(Storage.ChildrenoftheRevolution.SpyBuilding01) == 1 and
          player:getStorageValue(Storage.ChildrenoftheRevolution.SpyBuilding02) == 1 and
          player:getStorageValue(Storage.ChildrenoftheRevolution.SpyBuilding03) == 1
       then
        npcHandler:say(
          {
    ...
    elseif player:getStorageValue(Storage.ChildrenoftheRevolution.Questline) == 20 then
      ...
      npcHandler.topic[cid] = 0
    elseif
      player:getStorageValue(Storage.ChildrenoftheRevolution.Questline) == 21 and
    ...
    elseif player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 1 then
      npcHandler:say(
        "Ah you have returned. I azzume you already found zzome itemzz to build a proper dizzguizze? ",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 2 then
      npcHandler:say(
        "Be warned. Zze mountain pazzezz have been dezzerted for zzeveral weekzz now. No one made it acrozz and I fear you won't meet a zzingle friendly zzoul up zzere.",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 3 then
      npcHandler:say(
        "Exzztraordinary. We are mozzt fortunate to have zzezze documentzz in our handzz now. Zzizz would zzertainly help me to build an effective rezzizztanzze. Will you give zzem to me? ",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 5 then
      npcHandler:say(
        "I've marked itzz location on your map. Go and find out what happened zzere. In zze pazzt it wazz known azz zze Temple of Equilibrium. ",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 13 then
      ...
      -- WRATH OF THE EMPEROR QUEST
      npcHandler:say(
        "You did well on your quezzt zzo far. I hope you will reach zze great gate in time. If we are lucky, it will zztill be open. ... Zalamon: If not, it will already be overrun by enemy zzoldierzz. Direct confrontation will be inevitable in zzat cazze, palezzkin. Now clear your mind and approach zze portal.",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 20 then
      if player:removeItem(12323, 1) then
        npcHandler:say(
          "Zzizz izz not hizz head but clearly belonged to zze keeper. I - I am imprezzed. You can go now. Leave me alone for a zzecond. ",
          cid
        )
    ...
    elseif npcHandler.topic[cid] == 21 then
      if player:removeItem(12327, 1) then
        ...
        npcHandler:say(
          "Finally. At lazzt. Zze zzeptre izz - ourzz. Ourzz of courzze. A weapon we should uzze wizzely for our cauzze. I need a zzecond or two. Do you leave me already? ",
          cid
        )
        npcHandler.topic[cid] = 0
      end
