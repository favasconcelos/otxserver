...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "mission") then
    ...
    if cStorage == -1 then
      npcHandler:say(
        "Alright, you look bright enough to fulfil my requests - at least you do not fall asleep while standing there. Ahem... I heard about a certain inventor who created a {magic device} to actually sail the {sea of light}. Will you help me find him?",
        cid
      )
    ...
    elseif cStorage == 2 then
      if not player:removeItem(10613, 1) then
        npcHandler:say(
          "o have you talked to the beggar? What did he tell you? Where are the plans...? Wh...? He did? He is? You've already got the plans? Beautiful!! Amazing! Alright it will take some time to recapitulate these plans.",
          cid
        )
        return true
      end
      ...
      npcHandler:say(
        "So have you talked to the beggar? What did he tell you? Where are the plans...? Wh...? He did? He is? You've already got the plans? Beautiful!! Amazing! Alright it will take some time to recapitulate these plans.",
        cid
      )
    ...
    elseif cStorage == 3 then
      ...
      if timeStorage > os.time() then
        npcHandler:say(
          "It will take some time to work out the initial problem of the device. Come back when I've found the component needed to finish it. Alright, B connects to D and another two nails marked with S go... hmmm.",
          cid
        )
    ...
    elseif cStorage == 4 then
      npcHandler:say(
        "Did you enter the Lost Mines yet? They are west of Edron, close to the sea. You will also need a pick once you get to the crystal deposit.",
        cid
      )
    elseif cStorage == 5 then
      if player:getItemCount(10614) == 0 then
        npcHandler:say(
          "Hm, so did you find a rare crystal? Show me... hey! That's not a rare crystal. What... where did you get that anyway? Please return to me with the right crystal.",
          cid
        )
        return true
      end
    ...
    elseif cStorage == 7 then
      npcHandler:say(
        "Found the well yet? Look on one of the ice isles near Carlin. I'm perfectly sure that the well with the pedestal is located on one of them. And be careful with the carrying device, I only have this one prototype.",
        cid
      )
    elseif cStorage == 8 then
      npcHandler:say(
        "So have you found the well and entered the lair? I hope you can find the {mirror crystal} in there. It is the only way to finish the {Lightboat}.",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 2 then
      npcHandler:say(
        "The device needs a special crystal. It's called {mirror crystal}. The inventor somehow damaged it - with fatal results. He had to give up, as no second crystal was left to try. I, however, know of another one... but are you up to the task?",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 12 then
      npcHandler:say(
        "Of course you are. And here we go. I have to ask some questions first. One: You aint afraid of no ghost, right?",
        cid
      )
      npcHandler.topic[cid] = 13
    elseif npcHandler.topic[cid] == 13 then
      npcHandler:say(
        "Good. Two: You know that ghosts exist and/or have found and/or defeated one or more of them?",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 18 then
      npcHandler:say(
        "Good. Take this wand - we call it a spirit meter - and go to the graveyard I have marked on your map and take a few measurements on the graves.",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 19 then
      npcHandler:say(
        "Let me see the spirit meter. Hmmm... those are grave news you bring - uhm, you know what I mean. But this is awesome! Now I know for sure that the calibration is only some short bursts of magically enhanced energy away.",
        cid
      )
      player:addExperience(500, true)
  ...
  elseif msgcontains(msg, "collective apparitions") then
    ...
    if qStorage == -1 then
      if npcHandler.topic[cid] == 15 then
        npcHandler:say(
          "Ah well, let's forget about the scientific details - you will do just fine as long as you do exactly what I say. Ready for me to go on with your task?",
          cid
        )
  ...
  elseif msgcontains(msg, "no") then
    if npcHandler.topic[cid] == 1 then
      npcHandler:say(
        "Yes, maybe it was the right decision. Astronomical research is nothing for the faint-hearted.",
        cid
      )
    elseif npcHandler.topic[cid] == 2 then
      npcHandler:say(
        "Well, the... what? You... mean you're no longer interested? I see, well maybe I overestimated your spirit after all.",
        cid
      )
    elseif npcHandler.topic[cid] == 3 then
