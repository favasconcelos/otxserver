...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif npcHandler.topic[cid] == 1 then
    ...
    if cityTable then
      ...
      npcHandler:say(
        "IN " ..
          string.upper(msg) .. "! AND WHAT PROFESSION HAVE YOU CHOSEN: {KNIGHT}, {PALADIN}, {SORCERER}, OR {DRUID}?",
        cid
      )
  ...
  elseif npcHandler.topic[cid] == 3 then
    if msgcontains(msg, "yes") then
      ...
      player:sendTextMessage(
        ...
        "You have received a backpack with starting items for reaching the mainlands."
      )
