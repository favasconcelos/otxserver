...
local function creatureSayCallback(cid, type, msg)
  ...
  if
    msgcontains(msg, "silk") or msgcontains(msg, "yarn") or msgcontains(msg, "silk yarn") or
      msgcontains(msg, "spool of yarn")
   then
    if player:getStorageValue(Storage.FriendsandTraders.TheMermaidMarina) < 1 then
      npcHandler:say(
        "Um. You mean, you really want me to touch that gooey spider silk just because you need yarn? Well... do you think that I'm pretty?",
        cid
      )
      npcHandler.topic[cid] = 1
    elseif player:getStorageValue(Storage.FriendsandTraders.TheMermaidMarina) == 2 then
      npcHandler:say(
        "Okay... a deal is a deal, would you like me to create a {spool of yarn} from {10 pieces of spider silk}?",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") then
    if npcHandler.topic[cid] == 1 then
      npcHandler:say(
        "Well, everyone would say that in your position. Do you think that I'm really, absolutely the most stunning being that you have ever seen?",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 4 then
      if player:removeItem(5902, 50) then
        npcHandler:say(
          "Oh goodie! Thank you! Okay... I guess since my fingers are sticky now anyway, I will help you. From now on, if you bring me {10 pieces of spider silk}, I will create one {spool of yarn}.",
          cid
        )
        npcHandler.topic[cid] = 0
...
keywordHandler:addKeyword(
  ...
  StdModule.say,
  {
    ...
    text = "Sorry, I don't have a spare comb. I lost my favourite one when diving around in Calassa."
  }
)
keywordHandler:addKeyword(
  {"mermaid comb"},
