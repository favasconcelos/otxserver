...
local function greetCallback(cid)
  ...
  if
    greetMessage and player:getStorageValue(Storage.Diapason.Edala) == 1 and
      player:getStorageValue(Storage.Diapason.EdalaTimer) < os.time()
   then
...
blessKeyword:addChildKeyword(
  {"yes"},
  StdModule.bless,
  {npcHandler = npcHandler, text = "So receive the fire of the suns, pilgrim.", cost = "|BLESSCOST|", bless = 4}
)
blessKeyword:addChildKeyword(
  {""},
  StdModule.say,
