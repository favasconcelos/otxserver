...
noitems2 =
  "You do not have all the required items or you do not have the first addon, which by the way, is a requirement for this addon."
...
keywordHandler:addKeyword(
  {"wayfarer"},
  StdModule.say,
  {npcHandler = npcHandler, onlyFocus = true, text = "Ask about {first addon} or {second addon}."}
)
...
node1 =
  ...
  StdModule.say,
  {
    npcHandler = npcHandler,
    onlyFocus = true,
    text = "To achieve the first wayfarer addon you need to give me the Old Cape. Do you have them with you?"
  }
)
...
node2 =
  ...
  StdModule.say,
  {
    npcHandler = npcHandler,
    onlyFocus = true,
    text = "To achieve the second wayfarer addon you need to give me the Sedge Hat. Do you have them with you?"
  }
)
