...
local weapon = {
  ["axe"] = {
    carving = {normal = 25967, charged = 25968, heavilycharged = 25969, overcharged = 25970},
  ...
  ["blade"] = {
    carving = {normal = 25959, charged = 25960, heavilycharged = 25961, overcharged = 25962},
  ...
  ["bow"] = {
    carving = {normal = 25983, charged = 25984, heavilycharged = 25985, overcharged = 25986},
  ...
  ["chopper"] = {
    carving = {normal = 25971, charged = 25972, heavilycharged = 25973, overcharged = 25974},
  ...
  ["crossbow"] = {
    carving = {normal = 25987, charged = 25988, heavilycharged = 25989, overcharged = 25990},
  ...
  ["hammer"] = {
    carving = {normal = 25979, charged = 25980, heavilycharged = 25981, overcharged = 25982},
  ...
  ["mace"] = {
    carving = {normal = 25975, charged = 25976, heavilycharged = 25977, overcharged = 25978},
  ...
  ["rod"] = {
    carving = {normal = 25995, charged = 25996, heavilycharged = 25997, overcharged = 25998},
  ...
  ["slayer"] = {
    carving = {normal = 25963, charged = 25964, heavilycharged = 25965, overcharged = 25966},
  ...
  ["wand"] = {
    carving = {normal = 25991, charged = 25992, heavilycharged = 25993, overcharged = 25994},
...
local function creatureSayCallback(cid, type, msg)
  ...
  elseif msgcontains(msg, "information") and npcHandler.topic[cid] == 0 then
    npcHandler:say(
      {
        "Tokens are small objects made of metal or other materials. You can use them to buy superior equipment from token traders like me.",
        "There are several ways to obtain the tokens I'm interested in - killing certain bosses, for example. In exchange for a certain amount of tokens, I can offer you some first-class items."
      },
      cid
    )
  ...
  elseif npcHandler.topic[cid] == 1 and msgcontains(msg, "token") then
    npcHandler:say(
      "If you have any gold tokens with you, let's have a look! Maybe I can offer you something in exchange.",
      cid
    )
  ...
  elseif npcHandler.topic[cid] == 2 and msgcontains(msg, "gold") then
    npcHandler:say(
      {
        "Here's the deal, Jess Leewyn. For 100 of your gold tokens, I can offer you some special equipment pieces which you can charge with a certain item type. I have the following item types to offer: mayhem, remedy or carving. ...",
  ...
  elseif isInArray(weaponEnhance, msg:lower()) and npcHandler.topic[cid] == 1 then
    ...
    npcHandler:say(
      weaponEnhanceChoose[cid]:gsub("^%l", string.upper) ..
        " nice! Choose a weapon type: {axe}, {blade}, {bow}, {chopper}, {crossbow}, {hammer}, {mace}, {rod}, {slayer} or {wand}.",
      cid
    )
    npcHandler.topic[cid] = 2
  elseif isInArray(weaponType, msg:lower()) and npcHandler.topic[cid] == 2 then
    ...
    npcHandler:say(
      weaponTypeChoose[cid]:gsub("^%l", string.upper) ..
        " of " ..
          weaponEnhanceChoose[cid]:gsub("^%l", string.upper) ..
            " will cost " .. weapon[weaponTypeChoose[cid]].price .. " tokens. Would you like it?",
      cid
    )
    npcHandler.topic[cid] = 3
