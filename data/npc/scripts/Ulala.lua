...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "mission") then
    ...
    elseif player:getStorageValue(Storage.UnnaturalSelection.Questline) == 11 then
      npcHandler:say(
        "You prayed to Fasuon! Me saw ray of lights on mountain top! Beautiful it was. Me thank you for your help. Great hunt almost can't go wrong now!",
        cid
      )
  ...
  elseif msgcontains(msg, "yes") then
    if npcHandler.topic[cid] == 2 then
      if player:getItemCount(11113) >= 5 and player:getItemCount(5878) >= 5 and player:getItemCount(5876) >= 5 then
        ...
        npcHandler:say(
          "Me thank you! Me will bring sacrifice for Pandor. He surely be pleased with our work. Well your work, but me won't tell him. Teehee.",
          cid
        )
