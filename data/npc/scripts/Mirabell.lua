...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "pies") then
    if player:getStorageValue(Storage.WhatAFoolishQuest.PieBuying) == -1 then
      npcHandler:say(
        "Oh you've heard about my excellent pies, didn't you? I am flattered. Unfortunately I'm completely out of flour. I need 2 portions of flour for one pie. Just tell me when you have enough flour for your pies.",
        cid
      )
      return true
    end
  ...
  elseif msgcontains(msg, "yes") then
    if npcHandler.topic[cid] == 1 then
      if not player:removeItem(2692, 24) then
        npcHandler:say(
          "I think you are confusing the dust in your pockets with flour. You certainly do not have enough flour for 12 pies.",
          cid
        )
      ...
      player:setStorageValue(
        Storage.WhatAFoolishQuest.PieBuying,
        player:getStorageValue(Storage.WhatAFoolishQuest.PieBuying) + 1
      )
      npcHandler:say(
        "Excellent. Now I can start baking the pies. As you helped me, I will make you a good price for them.",
        cid
      )
      npcHandler.topic[cid] = 0
...
keywordHandler:addKeyword(
  ...
  StdModule.say,
  {
    ...
    text = "I can offer you beer, wine, lemonade and water. If you'd like to see my offers, ask me for a {trade}."
  }
)
keywordHandler:addKeyword(
  {"food"},
...
npcHandler:setMessage(
  MESSAGE_GREET,
  "Welcome to the Horn of Plenty, |PLAYERNAME|. Sit down, have a {drink} or some {food}!"
)
