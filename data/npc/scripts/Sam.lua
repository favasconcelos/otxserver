...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "adorn") or msgcontains(msg, "outfit") or msgcontains(msg, "addon") then
    ...
    if addonProgress == 5 then
      ...
      npcHandler:say(
        "Oh, Gregor sent you? I see. It will be my pleasure to adorn your helmet. Please give me some time to finish it.",
        cid
      )
  ...
  elseif msgcontains(msg, "2000 steel shields") then
    if
      player:getStorageValue(Storage.WhatAFoolishQuest.Questline) ~= 29 or
        player:getStorageValue(Storage.WhatAFoolishQuest.Contract) == 2
     then
      npcHandler:say(
        "My offers are weapons, armors, helmets, legs, and shields. If you'd like to see my offers, ask me for a {trade}.",
        cid
      )
      return true
    end
  ...
  elseif msgcontains(msg, "yes") then
    ...
    elseif npcHandler.topic[cid] == 2 then
      npcHandler:say(
        "I can't believe it. Finally I will be rich! I could move to Edron and enjoy my retirement! But ... wait a minute! I will not start working without a contract! Are you willing to sign one?",
        cid
      )
    ...
    elseif npcHandler.topic[cid] == 4 then
      ...
      npcHandler:say(
        "Excellent! I will start working right away! Now that I am going to be rich, I will take the opportunity to tell some people what I REALLY think about them!",
        cid
      )
      npcHandler.topic[cid] = 0
    end
...
keywordHandler:addKeyword(
  {"job"},
  StdModule.say,
  {npcHandler = npcHandler, text = "I am the blacksmith. If you need weapons or armor - just ask me."}
)
