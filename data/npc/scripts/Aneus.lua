...
keywordHandler:addKeyword(
  ...
  StdModule.say,
  {
    ...
    text = "It was the elite of the whole army. They were called the Red Legion (also known as the bloody legion)."
  }
)
keywordHandler:addKeyword(
  {"orcs"},
...
keywordHandler:addKeyword(
  {"cruelty"},
  StdModule.say,
  {npcHandler = npcHandler, text = "The soldiers treated the workers like slaves."}
)
keywordHandler:addKeyword(
  {"island"},
  StdModule.say,
  {
    npcHandler = npcHandler,
    text = "The General of the Red Legion became very angry about these attacks and after some months he STROKE back!"
  }
)
