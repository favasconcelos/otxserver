...
local function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg, "gratitude") then
    ...
    npcHandler:say(
      "Oh, so you want a reward, hm? Well... let's see. What did you do for us - helping Mortis with his {repairs} and defended him?",
      cid
    )
  elseif msgcontains(msg, "repairs") then
    if npcHandler.topic[cid] == 3 then
      if player:getInquisitionGold() > 0 then
        ...
        npcHandler:say(
          {
            "Alright, so you mixed and delivered " ..
              math.max(0, player:getStorageValue(ROSHAMUUL_MORTAR_THROWN)) .. " mortar and ...",
            "You killed " .. math.max(0, player:getStorageValue(ROSHAMUUL_KILLED_FRAZZLEMAWS)) .. " frazzlemaws and ...",
            "You also hunted " ..
              math.max(0, player:getStorageValue(ROSHAMUUL_KILLED_SILENCERS)) ..
                " silencers. That would equal " ..
                  player:getInquisitionGold() ..
                    " of inquisition gold - BUT we are currently short of this valuable metal so... do you want me to add this amount to my {books} for now or {trade} it for something else."
          },
          cid
        )
      else
  ...
  elseif npcHandler.topic[cid] == 4 then
    ...
    if msgcontains(msg, "book") or msgcontains(msg, "books") then
      ...
      npcHandler:say(
        {
          "Of course, let's see. Hm, your recent endeavours would earn you " ..
            player:getInquisitionGold() ..
              " of righteous inquisition gold. You have earned " .. v .. " of gold in total. ...",
      ...
      npcHandler:say(
        {
          "Good. Registered as... " ..
            player:getName() ..
              "... with... about " ..
                player:getInquisitionGold() ..
                  " of righteously earned inquisition gold added. There. Thanks for your help! ..",
  ...
  elseif msgcontains(msg, "trade") then
    ...
    if v >= 100 then
      ...
      npcHandler:say(
        "Ah yes, you currently have " ..
          v ..
            " of righteously earned inquisition gold in my book. 100 inquisition gold equals one cluster. How many clusters do you want in exchange?",
        cid
      )
    else
      npcHandler.topic[cid] = nil
      npcHandler:say(
        "You do not seem to have enough inquisition gold yet to trade for clusters, as it's registered in my book.",
        cid
      )
    end
  elseif npcHandler.topic[cid] == 6 then
    ...
    if v > max then
      return npcHandler:say(
        "You do not have enough inquisition gold for that, so far you can ask for up to " .. max .. " clusters.",
        cid
      )
    end
    ...
    npcHandler:say(
      "There you are. Now I register " ..
        player:getStorageValue(ROSHAMUUL_GOLD_RECORD) .. " inquisition gold of yours in my book.",
      cid
    )
  end
  ...
  if msgcontains(msg, "bucket") or msgcontains(msg, "supplies") then
    npcHandler:say(
      "Head to brother Maun if you are in need of basic supplies. He will help you - for a small fee.",
      cid
    )
  elseif msgcontains(msg, "maun") then
    npcHandler:say(
      "Brother Maun is a valuable member of the Inquisition. He will help you out with supplies. Provided you can actually compensate of course.",
      cid
    )
  end
  return true
