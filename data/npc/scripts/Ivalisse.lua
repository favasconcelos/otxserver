...
function creatureSayCallback(cid, type, msg)
  ...
  if player:getStorageValue(50730) < 1 then
    if msgcontains(msg, "temple") then
      npcHandler:say(
        {
          "I can't tell you much right now, but you can contribute to our rebuilding by talking about the shaper's temple to Albinius first."
        },
        cid
      )
    end
  elseif player:getStorageValue(50734) <= 0 then
    if msgcontains(msg, "temple") then
      npcHandler:say(
        {
          "Well, I hope you like it here. We tried to rebuild in the Shaper's will. I am a bit preoccupied at the moment because of the absence of my {father}. I may not be the best of help currently."
        },
        cid
      )
...
keywordHandler:addKeyword(
  ...
  StdModule.say,
  {
    ...
    text = "Besides my various {duties} in the temple, I also take care of visitors. Well, I would but right now I can't get my mind of how my father's doing. I am sorry."
  }
)
keywordHandler:addKeyword(
  {"duties"},
  ...
  {
    npcHandler = npcHandler,
    text = "I help linking the portals of this temple to other ancient sites of the Astral Shapers."
  }
)
keywordHandler:addKeyword(
  {"astral shapers"},
  ...
  {
    npcHandler = npcHandler,
    text = "As far as we know today, the Astral Shapers are an ancient, very advanced race of master artisans."
  }
)
...
keywordHandler:addKeyword(
  {"silus"},
  StdModule.say,
  {npcHandler = npcHandler, text = "My father, can you tell me if he's alright?"}
)
keywordHandler:addKeyword(
  {"albinius"},
  StdModule.say,
  {
    npcHandler = npcHandler,
    text = "Me and him are rebuilding the shaper's temple. He's a great person, very intelligent. He'll help you through our rebuilding process."
  }
)
keywordHandler:addKeyword(
  {"thais"},
  StdModule.say,
  {npcHandler = npcHandler, text = "Alright then, you are very welcome to explore the temple!"}
)
