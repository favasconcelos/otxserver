...
function creatureSayCallback(cid, type, msg)
  ...
  if (msgcontains(msg, "mission") or msgcontains(msg, "task")) then
    ...
    if (getPlayerStorageValue(cid, 41600) < 1) and getPlayerStorageValue(cid, 43600) <= os.time() then
      npcHandler:say(
        "Oh, you want some work? You can help us, alright. Did you know that the people of the city think those rabbit feet are actually lucky charms?",
        cid
      )
    ...
    elseif (getPlayerStorageValue(cid, 41600) == 5) and getPlayerStorageValue(cid, 41660) == 4 then
      npcHandler:say(
        "You did it!! And I assume you took only what you needed? Heh. No, I know it. Because my men took the rest. Thanks for helping us, you did a very good job. In fact I have a little 'extra' for you here, thanks again.",
        cid
      )
      ------------------ RESET STORAGE --------------------
  ...
  elseif (msgcontains(msg, "yes")) then
    ...
    elseif (npcHandler.topic[cid] == 3) and getPlayerItemCount(cid, 13160) >= 7 then
      npcHandler:say(
        "Good hunt. That will be enough to help us uhm... get through the winter yes. Now if you want to help us getting even more lucky charms, you can always ask.",
        cid
      )
    ...
    elseif (npcHandler.topic[cid] == 4) then
      npcHandler:say(
        "Good, good. Do you remember the old saying? If it ain't broken, it was not made by us. Now, off you go!",
        cid
      )
