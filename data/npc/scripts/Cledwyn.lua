...
local items = {
  item1 = {25172, 13030}, -- item1 item que ser� pedido e que ser� dado na primeira troca
  item2 = {25172, 25177},
  item3 = {25172, 25179},
  item4 = {25172, 25191},
  item5 = {25172, 25187},
...
local counts = {
  count1 = {100, 1}, -- count1 quantidade que ser� pedido e que ser� dado na primeira troca
  count2 = {100, 1},
  count3 = {100, 1},
  count4 = {100, 1},
  count5 = {100, 1},
    ...
    if getPlayerItemCount(cid, items.item2[1]) >= counts.count2[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count2[1] ..
            " " ..
              getItemName(items.item2[1]) .. " for " .. counts.count2[2] .. " " .. getItemName(items.item2[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item3[1]) >= counts.count3[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count3[1] ..
            " " ..
              getItemName(items.item3[1]) .. " for " .. counts.count3[2] .. " " .. getItemName(items.item3[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item4[1]) >= counts.count4[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count4[1] ..
            " " ..
              getItemName(items.item4[1]) .. " for " .. counts.count4[2] .. " " .. getItemName(items.item4[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item5[1]) >= counts.count5[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count5[1] ..
            " " ..
              getItemName(items.item5[1]) .. " for " .. counts.count5[2] .. " " .. getItemName(items.item5[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item6[1]) >= counts.count6[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count6[1] ..
            " " ..
              getItemName(items.item6[1]) .. " for " .. counts.count6[2] .. " " .. getItemName(items.item6[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item7[1]) >= counts.count7[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count7[1] ..
            " " ..
              getItemName(items.item7[1]) .. " for " .. counts.count7[2] .. " " .. getItemName(items.item7[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item8[1]) >= counts.count8[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count8[1] ..
            " " ..
              getItemName(items.item8[1]) .. " for " .. counts.count8[2] .. " " .. getItemName(items.item8[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item9[1]) >= counts.count9[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count9[1] ..
            " " ..
              getItemName(items.item9[1]) .. " for " .. counts.count9[2] .. " " .. getItemName(items.item9[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item10[1]) >= counts.count10[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count10[1] ..
            " " ..
              getItemName(items.item10[1]) .. " for " .. counts.count10[2] .. " " .. getItemName(items.item10[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item11[1]) >= counts.count11[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count11[1] ..
            " " ..
              getItemName(items.item11[1]) .. " for " .. counts.count11[2] .. " " .. getItemName(items.item11[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item12[1]) >= counts.count12[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count12[1] ..
            " " ..
              getItemName(items.item12[1]) .. " for " .. counts.count12[2] .. " " .. getItemName(items.item12[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item13[1]) >= counts.count13[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count13[1] ..
            " " ..
              getItemName(items.item13[1]) .. " for " .. counts.count13[2] .. " " .. getItemName(items.item13[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item14[1]) >= counts.count14[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count14[1] ..
            " " ..
              getItemName(items.item14[1]) .. " for " .. counts.count14[2] .. " " .. getItemName(items.item14[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item15[1]) >= counts.count15[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count15[1] ..
            " " ..
              getItemName(items.item15[1]) .. " for " .. counts.count15[2] .. " " .. getItemName(items.item15[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item16[1]) >= counts.count16[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count16[1] ..
            " " ..
              getItemName(items.item16[1]) .. " for " .. counts.count16[2] .. " " .. getItemName(items.item16[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item17[1]) >= counts.count17[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count17[1] ..
            " " ..
              getItemName(items.item17[1]) .. " for " .. counts.count17[2] .. " " .. getItemName(items.item17[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item18[1]) >= counts.count18[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count18[1] ..
            " " ..
              getItemName(items.item18[1]) .. " for " .. counts.count18[2] .. " " .. getItemName(items.item18[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item19[1]) >= counts.count19[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count19[1] ..
            " " ..
              getItemName(items.item19[1]) .. " for " .. counts.count19[2] .. " " .. getItemName(items.item19[2]) .. ".",
        cid
      )
    else
    ...
    if getPlayerItemCount(cid, items.item20[1]) >= counts.count20[1] then
      ...
      selfSay(
        "You just swap " ..
          counts.count20[1] ..
            " " ..
              getItemName(items.item20[1]) .. " for " .. counts.count20[2] .. " " .. getItemName(items.item20[2]) .. ".",
        cid
      )
    else
