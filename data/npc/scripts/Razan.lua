  ...
  if msgcontains(msg, "outfit") then
    npcHandler:say(
      player:getSex() == PLAYERSEX_FEMALE and
        "My turban? I know something better for a pretty girl like you. Why don't you go talk to Miraia?" or
        "My turban? Eh no, you can't have it. Only oriental weaponmasters may wear it after having completed a difficult task.",
      cid
    )
