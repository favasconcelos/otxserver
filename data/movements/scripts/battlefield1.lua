...
function onStepIn(creature, item, position, fromPosition)
  ...
  if Game.getStorageValue(_Lib_Battle_Info1.storage_count1) > 0 then
    local getMyTeam1 =
      ...
      Game.getStorageValue(_Lib_Battle_Info1.TeamTwo1.storage1) and
      {
        _Lib_Battle_Info1.TeamOne1.storage1,
        _Lib_Battle_Info1.TeamOne1.pos1,
        _Lib_Battle_Info1.TeamOne1.name1,
        conditionBlack1
      } or
      {
        _Lib_Battle_Info1.TeamTwo1.storage1,
        _Lib_Battle_Info1.TeamTwo1.pos1,
        _Lib_Battle_Info1.TeamTwo1.name1,
        conditionRed1
      }
