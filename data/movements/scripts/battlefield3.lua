...
function onStepIn(creature, item, position, fromPosition)
  ...
  if Game.getStorageValue(_Lib_Battle_Info3.storage_count3) > 0 then
    local getMyTeam3 =
      Game.getStorageValue(_Lib_Battle_Info3.TeamOne3.storage3) <
      Game.getStorageValue(_Lib_Battle_Info3.TeamTwo3.storage3) and
      {
        _Lib_Battle_Info3.TeamOne3.storage3,
        _Lib_Battle_Info3.TeamOne3.pos3,
        _Lib_Battle_Info3.TeamOne3.name3,
        conditionBlack3
      } or
      {
        _Lib_Battle_Info3.TeamTwo3.storage3,
        _Lib_Battle_Info3.TeamTwo3.pos3,
        _Lib_Battle_Info3.TeamTwo3.name3,
        conditionRed3
      }
