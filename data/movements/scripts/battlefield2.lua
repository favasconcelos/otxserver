...
function onStepIn(creature, item, position, fromPosition)
  ...
  if Game.getStorageValue(_Lib_Battle_Info2.storage_count2) > 0 then
    local getMyTeam2 =
      Game.getStorageValue(_Lib_Battle_Info2.TeamOne2.storage2) <
      Game.getStorageValue(_Lib_Battle_Info2.TeamTwo2.storage2) and
      {
        _Lib_Battle_Info2.TeamOne2.storage2,
        _Lib_Battle_Info2.TeamOne2.pos2,
        _Lib_Battle_Info2.TeamOne2.name2,
        conditionBlack2
      } or
      {
        _Lib_Battle_Info2.TeamTwo2.storage2,
        _Lib_Battle_Info2.TeamTwo2.pos2,
        _Lib_Battle_Info2.TeamTwo2.name2,
        conditionRed2
      }
