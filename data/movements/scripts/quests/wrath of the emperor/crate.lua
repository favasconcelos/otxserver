function catchPlayer(cid)
  ...
  player:say(
    "The guards have spotted you. You were forcibly dragged into a small cell. It looks like you need to build another disguise.",
...
function onStepIn(creature, item, position, fromPosition)
  ...
  if item.actionid == 8015 then
    player:say(
      "You hear guards moving behind doors in the distance. If you have any sort of disguise with you, this is the moment to use it.",
      TALKTYPE_MONSTER_SAY
    )
  ...
  elseif item.actionid == 8021 then
    player:say(
      "Guards heavily patrol this area. Try to stay hidden and do not draw any attention to yourself by trying to attack.",
      TALKTYPE_MONSTER_SAY
    )
