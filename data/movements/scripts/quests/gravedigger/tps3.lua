...
function onStepIn(creature, item, position, fromPosition)
  ...
  if
    item.actionid == 4534 and player:getStorageValue(Storage.GravediggerOfDrefia.Mission55) == 1 and
      player:getStorageValue(Storage.GravediggerOfDrefia.Mission56) < 1
   then
