...
function onStepIn(creature, item, position, fromPosition)
  ...
  if
    checkPillows(arenaPosition.x, arenaPosition.y, 1686) and checkPillows(arenaPosition.x + 3, arenaPosition.y, 1688) and
      checkPillows(arenaPosition.x, arenaPosition.y + 3, 1687) and
      checkPillows(arenaPosition.x + 3, arenaPosition.y + 3, 1689)
   then
