function onStepIn(creature, item, position, fromPosition)
  ...
  if player:getLevel() > 99 then
    ...
    -- BF 0 --
    local MyTeam =
      creature:getStorageValue(_Lib_Battle_Info.TeamOne.storage) >= 1 and _Lib_Battle_Info.TeamOne.storage or
      _Lib_Battle_Info.TeamTwo.storage
    ...
    -- BF 2 --
    local MyTeam2 =
      creature:getStorageValue(_Lib_Battle_Info2.TeamOne2.storage2) >= 1 and _Lib_Battle_Info2.TeamOne2.storage2 or
      _Lib_Battle_Info2.TeamTwo2.storage2
    ...
    -- BF 3 --
    local MyTeam3 =
      creature:getStorageValue(_Lib_Battle_Info3.TeamOne3.storage3) >= 1 and _Lib_Battle_Info3.TeamOne3.storage3 or
      _Lib_Battle_Info3.TeamTwo3.storage3
