local overlords = {
  ["energy overlord"] = {
    cStorage = Storage.ElementalSphere.BossStorage,
    cGlobalStorage = GlobalStorage.ElementalSphere.KnightBoss
  },
  ["fire overlord"] = {
    cStorage = Storage.ElementalSphere.BossStorage,
    cGlobalStorage = GlobalStorage.ElementalSphere.SorcererBoss
  },
  ["ice overlord"] = {
    cStorage = Storage.ElementalSphere.BossStorage,
    cGlobalStorage = GlobalStorage.ElementalSphere.PaladinBoss
  },
  ["earth overlord"] = {
    cStorage = Storage.ElementalSphere.BossStorage,
    cGlobalStorage = GlobalStorage.ElementalSphere.DruidBoss
  },
