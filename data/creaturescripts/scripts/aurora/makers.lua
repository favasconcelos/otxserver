...
function equip(cid, item, slot)
  ...
  for sl, n in pairs(t) do
    ...
    elseif sl == "magically" then
      if
        getPlayerVocation(cid) == 1 or getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 5 or
          getPlayerVocation(cid) == 6 or
          getPlayerVocation(cid) == 9 or
          getPlayerVocation(cid) == 10
       then
    ...
    elseif sl == "blessed" then
      if
        getPlayerVocation(cid) == 3 or getPlayerVocation(cid) == 4 or getPlayerVocation(cid) == 7 or
          getPlayerVocation(cid) == 8 or
          getPlayerVocation(cid) == 11 or
          getPlayerVocation(cid) == 12
       then
