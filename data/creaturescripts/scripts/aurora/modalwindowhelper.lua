function onModalWindow(player, modalWindowId, buttonId, choiceId)
  ...
  if (buttonId == 100) then
    ...
    local p_house = result.getString(p_db, "id")
     -- Pega id da house retornado pela query da variavel p_db
    ...
    player:sendTextMessage(
      ...
      "You were teleported to the house of " .. result.getString(p, "name")
    )
