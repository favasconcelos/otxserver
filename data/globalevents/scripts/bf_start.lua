...
local function warnEvent(i)
  Game.broadcastMessage(
    "Battlefield event was opened, a teleport was created in the Event Room (entrance through Temple of Thais)!",
...
function onTime(interval)
  Game.broadcastMessage(
    "Teleport for The BattleField Event was created in Event Room, you have 10 minutes for join if you want.",
    MESSAGE_EVENT_ADVANCE
  )
