function onThink(interval)
  if _Lib_Battle_Days1[os.date("%A")] then
    ...
    if tb1 and (tb1.players1 % 2 == 0) then
      ...
      broadcastMessage(
        "[BattleField] Um teleport foi criado no Event Room [Templo de Thais], voces tem 10 minutos para entrar, apenas " ..
          tb1.players1 ..
            " jogadores poderao entrar, para serem divididos em " ..
              ((tb1.players1) / 2) .. " VS " .. ((tb1.players1) / 2) .. "."
      )
    end
  end
  return true
