...
function onTime()
  ...
  broadcastMessage(
    "Capture the Flag event will start in 10 minutes, entrance in Event Room [Temple Thais].",
    MESSAGE_EVENT_ADVANCE
  )
  addEvent(
    broadcastMessage,
    5 * 60 * 1000,
    "Capture the Flag event will start in 5 minutes, entrance in Event Room [Temple Thais].",
    MESSAGE_EVENT_ADVANCE
  )
  addEvent(
    broadcastMessage,
    8 * 60 * 1000,
    "Capture the Flag event will start in 2 minutes, entrance in Event Room [Temple Thais].",
    MESSAGE_EVENT_ADVANCE
  )
