...
local config = {
  teleportId = 1285,
  dias = {
    ["Saturday"] = {Position(33665, 31887, 5), Position(33647, 31254, 11)}, -- S�bado IRA DO MAL -- GOLENS
    ...
    ["Tuesday"] = {Position(33669, 31887, 5), Position(33647, 31254, 11)}, -- Ter�a-feira GOLENS -- IRA DO MAL
