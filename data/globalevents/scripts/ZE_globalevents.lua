  ...
  if tile then
    ...
    if item then
      ...
      Game.broadcastMessage(
        "The Zombie Event was opened and will be closed in " .. ZE.tpTimeOpen .. " minutes.",
...
local function SumonarZumbis(b)
  Game.createMonster(
    "Zumbi",
    {
      x = math.random(zeArenaFromPosition.x, zeArenaToPosition.x),
      y = math.random(zeArenaFromPosition.y, zeArenaToPosition.y),
      z = math.random(zeArenaFromPosition.z, zeArenaToPosition.z)
    },
    false,
    true
  )
