...
SnowBall_Configurations = {
  Event_Duration = 5, -- Minutos de dura��o do jogo.
  Event_WaitGame = 2, -- Minutos de espera para o inicio do jogo, dentro da sala.
  Event_MinPlayers = 2, -- Minimo de jogadores para o jogo come�ar, caso contr�rio, o jogo � cancelado.
  ...
  Event_Days = {1, 2, 3, 4, 5, 6, 7}, -- Dias que ir� ocorrer o evento (seguindo a ordem de 1 = domingo, 7 = sabado)
  Area_Configurations = {
    Area_Arena = {{x = 32507, y = 32372, z = 7}, {x = 32551, y = 32415, z = 7}}, -- Area da arena do jogo, ({Canto Superior Esquerdo}, {Canto Inferior Direito})
    Position_WaitRoom = {x = 33146, y = 32175, z = 9}, -- Posi��o da sala de espera do jogo
    Position_ExitWaitRoom = {x = 33146, y = 32172, z = 9}, -- Posi��o do teleport que sair� da sala de espera do jogo
    Position_EventTeleport = {x = 32310, y = 31896, z = 6} -- Posi��o de onde ser� criado o teleport para os participantes irem para a sala de espera.
  },
  Ammo_Configurations = {
    Ammo_Price = 1, -- Pre�o da munica��o em pontos do jogo.
    Ammo_Ammount = 100, -- Quantidade de ganho a cada compra.
    Ammo_Start = 100, -- Quantidade de munica��o de cada jogador ao inicio do jogo.
    Ammo_Restart = 50, -- Quantidade de munica��o do jogador, caso ele morra. // Caso queira desativar, valor = 0.
    Ammo_Speed = 150, -- Velocidade de cada tiro
    Ammo_Infinity = false, -- Se as muni��es ser�o infinitas ou n�o (True / False)
    Ammo_Exhaust = 1, -- Segundos de espera para utilizar novamente o comando !snowball atirar
    Ammo_Distance = 6 -- Quantidade de tiles que o tiro ir� alcan�ars
  },
  Positions_Rewards = {
    [1] = {
      -- Pr�mios do primeiro lugar
      [2160] = 30
    },
    [2] = {
      -- Pr�mios do segundo lugar
      [2160] = 20
    },
    [3] = {
      -- Pr�mios do terceiro lugar
      [2160] = 10
    }
    --[[ Caso queira adicionar pr�mios para outras posi��es basta seguir o exemplo:
		[Posi��o] = {
...
-- ################# SnowBall Functions -- Por favor, n�o mexer. Desenvolvido inteiramente por Tony Ara�jo (OrochiElf) ################# --
CACHE_GAMEPLAYERS = {}
        ...
        if Tile(newPos):getTopCreature() then
          ...
          if Player(killed:getId()) then
            ...
            table.sort(
              CACHE_GAMEPLAYERS,
              function(a, b)
                return Player(a):getStorageValue(10109) > Player(b):getStorageValue(10109)
              end
            )
          else
